page 50009 "Accountant Role Centre KETRB"
{
    Caption = 'Accountant Role Centre KETRB';
    PageType = RoleCenter;
...
//-----------------------------------------------------------------------            
            group(Action172)
            {
                ...
                action("Bank Account Posting Groups")
                {
                 ...
                 action("Billing Charge Setup")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Billing Charge Setup';
                    RunObject = Page "Billing Charge Setup" ;
                    ToolTip = 'Set up posting groups, so that payments in and out of each bank account are posted to the specified general ledger account.';
                }
            }
            group(Journals)
            ...
            group("Funds Management")
            {
                ...
                ToolTip = 'Process on incoming and outcoming funds.  ';
                ...
                action(PettyCashVoucher)
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = Page "Petty Cash Voucher";
                ...
                action(PostedPettyCashVouchers1)
                {
                    ApplicationArea = Basic, Suite;
                ...
                action("Approved Bank Transfers")
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = Page "Approved Bank Transfers";
            ...
            {
                Caption = 'FinancialReports';
                Image = Reports;
                ToolTip = 'View the Financial Reports.';
                ...
                action("Cost Accounting PL Statement")
                {
                    Caption = 'Cost Accounting P/L Statement';
                    Image = "Report";
                    RunObject = Report "Cost Acctg. Statement";
                }
                action("CA PL Statement per Period")
                {
                    Caption = 'CA P/L Statement per Period';
                    Image = "Report";
                    RunObject = Report "Cost Acctg. Stmt. per Period";
                }
                action("CA PL Statement with Budget")
                {
                    Caption = 'CA P/L Statement with Budget';
                    Image = "Report";
                    RunObject = Report "Cost Acctg. Statement/Budget";
                }
                action("Cost AccountingAnalysis")
                {
                    Caption = 'Cost Accounting Analysis';
                    Image = "Report";
                    RunObject = Report "Cost Acctg. Analysis";
