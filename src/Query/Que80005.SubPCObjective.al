...
Query 50005 "SubPCObjectives"
{

    elements
    {
        dataitem(Sub_PC_Objective; "Sub PC Objective")
        {
            ...
            column(Sub_Targets; "Sub Targets")
            {
            }
            column(Entry_Number; "Entry Number")
            {
            }
            column(Sub_Activity_weight; "Sub Activity weight %")
            {
            }
        }
    }
