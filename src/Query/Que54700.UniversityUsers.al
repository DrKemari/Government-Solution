...
Query 54700 "UniversityUsers"
{

    elements
    {
        dataitem(UniversityUsers;UniversityUsers)
        {
            ...
            column(UniversityCode;UniversityCode)
            {
            }
            column(University_Name;"University Name")
            {
            }
            ...
            {
                DataItemLink = "No."=UniversityUsers.UniversityCode;
