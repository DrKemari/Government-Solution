...
Page 52031 "Completed Road Section"
{
    Caption = 'Closed Project Card';
    PageType = Document;
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Project Funding Contract No"; Rec."Project Funding Contract No")
                {
                    ...
                    ToolTip = 'Specifies the value of the Project Funding Contract No field.';
                }
                field("Country Entry Code"; Rec."Country Entry Code")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Country Entry Code field.';
                }
                ...
                {
                    ApplicationArea = Jobs;
                    Caption = 'Principle Invistigator';
                    Importance = Promoted;
            ...
            group("Award Setup")
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Assistance Type field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the CFDA No. field.';
                }
            ...
            group("Grantor Details")
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantor Financial Contact ID field.';
                }
                field("Grantor Financial Contact Name"; Rec."Grantor Financial Contact Name")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantor Financial Contact Name field.';
                }
                field("Grantor Authorized Official ID"; Rec."Grantor Authorized Official ID")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantor Authorized Official ID field.';
                }
                field("Grantor Authorized Official"; Rec."Grantor Authorized Official")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantor Authorized Official field.';
                }
            }
            group("Grantee Details")
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantee Name field.';
                }
                field("Grantee Address"; Rec."Grantee Address")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantee Address field.';
                }
                field("Grantee Address 2"; Rec."Grantee Address 2")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantee Address 2 field.';
                }
                field("Grantee Post Code"; Rec."Grantee Post Code")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantee Post Code field.';
                }
                field("Grantee City"; Rec."Grantee City")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantee City field.';
                }
                field("Grantee Country/Region"; Rec."Grantee Country/Region")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantee Country/Region field.';
                }
                field("Grantee Admin Contact ID"; Rec."Grantee Admin Contact ID")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantee Admin Contact ID field.';
                }
                field("Grantee Admin Contact Name"; Rec."Grantee Admin Contact Name")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantee Admin Contact Name field.';
                }
                field("Grantee Financial Contact ID"; Rec."Grantee Financial Contact ID")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantee Financial Contact ID field.';
                }
                field("Grantee Financial Contact Name"; Rec."Grantee Financial Contact Name")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantee Financial Contact Name field.';
                }
                field("Grantee Authorized Official ID"; Rec."Grantee Authorized Official ID")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantee Authorized Official ID field.';
                }
                field("Grantee Authorized Official"; Rec."Grantee Authorized Official")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Grantee Authorized Official field.';
                }
            }
            group("Finance Metrics")
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Total Approved Direct Costs field.';
                }
                field("Total Approved Indirect Costs"; Rec."Total Approved Indirect Costs")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Total Approved Indirect Costs field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Total Approved Budget field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Total Invoiced Amount field.';
                }
        ...
        area(navigation)
        {
            ...
            group("Research Project")
            {
                action("Project Research Team List")
                {
                    ...
                    RunPageLink = "Job No" = field("No.");
                    ToolTip = 'Executes the Project Research Team List action.';
                }
                action("Project Research Objectives")
                {
                    ...
                    ToolTip = 'Executes the Project Research Objectives action.';
                }
                action("Effort & Payroll Matrix list")
                {
                    ...
                    RunPageLink = "Project No" = field("No.");
                    ToolTip = 'Executes the Payroll Effort & Payroll Matrix list action.';
                }
            }
        }
        area(processing)
