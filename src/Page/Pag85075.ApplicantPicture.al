...
/// <summary>
/// Page Applicant Picture (ID 85075).
/// </summary>
#pragma implicitwith disable
Page 85075 "Applicant Picture"
{
    ...
    // begin
    //     Rec.SetEditableOnPictureActions;
    // end;

    // trigger OnOpenPage()
    // begin
    //     CameraAvailable := Rec.CameraProvider.IsAvailable;
    //     if CameraAvailable then
    //         Rec.CameraProvider := Rec.CameraProvider.Create;
    // end;
