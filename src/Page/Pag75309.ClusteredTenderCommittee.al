...
Page 75309 "Clustered Tender Committee"
{
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Committee Type"; Rec."Committee Type")
                {
                    ...
                    begin
                        ...
                        if ProcCommType.FindSet then begin
                            Rec.Description := ProcCommType.Description;
                        end;
                    end;
                }
                ...
                field(Duration; Rec.Duration)
                {
                    ...
                    ToolTip = 'Specifies the value of the Imprest Duration(Days) field.';
                }
    ...
    begin
        Rec.Type := Rec.Type::Clustered;
        Rec."Document Date" := Today;
        Rec."Appointment Effective Date" := Today;
        Rec.Modify(true);
    end;
