...
/// <summary>
/// Page Road Construction Project Card (ID 72049).
/// </summary>
#pragma implicitwith disable
Page 72049 "Road Construction Project Card"
{
    ...
    SourceTable = Job;
    SourceTableView = where("Project Category" = const(Road));
    ...
    layout
    {
        area(content)
        {
            ...
            group("Road Project Details")
            {
                Caption = 'Road Project Details';
                field("Project Category"; Rec."Project Category")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
                field("Road Project Type"; Rec."Road Project Type")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
                field("Road Project Sub-Category"; Rec."Road Project Sub-Category")
                {
                    ApplicationArea = Basic;
                }
            }
    ...
    begin
        ...
        Rec."Project Category" := Rec."project category"::Road;
        Rec."Road Project Type" := Rec."road project type"::Construction;
    end;
