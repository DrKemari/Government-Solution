...
Page 85191 "Posted Certificate Collection"
{
    ApplicationArea = Basic;
    Caption = 'Certificate Collect Vouchers';
    CardPageID = "Posted Certificate Collect Car";
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
    ModifyAllowed = false;
    ...
    SourceTableView = where("Document Type"=filter(Collection),
                            Posted=filter(true));
