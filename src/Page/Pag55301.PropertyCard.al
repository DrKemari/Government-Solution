...
Page 55301 "Property Card"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Land Registration Number"; Rec."Land Registration Number")
                {
                    ApplicationArea = Basic;
                }
                field("Total Size in Sq Feet"; Rec."Total Size in Sq Feet")
                {
                    ApplicationArea = Basic;
                }
                ...
                field("Land size (Acres)"; Rec."Land size (Acres)")
                {
                    ApplicationArea = Basic;
                }
                field("Survey Plan Number"; Rec."Survey Plan Number")
                {
                    ApplicationArea = Basic;
                }
                field("Development Status"; Rec."Development Status")
                {
                    ApplicationArea = Basic;
                }
                field("File Reference Number"; Rec."File Reference Number")
                {
                    ApplicationArea = Basic;
                }
                ...
                field("Enviromental Assesment Status"; Rec."Enviromental Assesment Status")
                {
                    ApplicationArea = Basic;
                }
                field("Lease/Tenant Spaces"; Rec."Lease/Tenant Spaces")
                {
                    ApplicationArea = Basic;
                }
                field("Lease Contracts"; Rec."Lease Contracts")
                {
                    ApplicationArea = Basic;
                }
                group(Control34)
            ...
            group("Depreciation Book")
            {
                ...
                field(BookValue; FADepreciationBook."Book Value")
                {
                    ApplicationArea = FixedAssets;
                    Caption = 'Book Value';
                    Editable = false;
    ...
    begin
        Rec."Asset Type" := Rec."asset type"::Property;
    end;
