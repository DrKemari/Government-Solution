...
Page 52029 "Open Road Section"
{
    Caption = 'Open Road Sections';
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Road Project No"; Rec."Road Project No")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Road Project No field.';
                }
