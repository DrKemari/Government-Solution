...
Page 51391 "Individual Site Visit Card"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    TableRelation = "Accreditation Application" where(Status = const("Awaiting Peer Review"));
            ...
            part(Control24; "Visitation Lines")
            {
                SubPageLink = "Evaluation Header No." = field(Code);
                ApplicationArea = Basic;
            }
            part(Control9; "Accreditation Trainers")
            {
                Caption = 'Trainers';
                SubPageLink = "Application No." = field(Code);
                ApplicationArea = Basic;
            }
            part(Control11; "Accreditation Students")
            {
                Caption = 'Students Per Course';
                SubPageLink = "Application No." = field("Application No.");
                ApplicationArea = Basic;
            }
            part(Control13; "Accreditation Courses")
            {
                SubPageLink = "Application No." = field("Application No.");
                ApplicationArea = Basic;
            }
    ...
    begin
        ...
        Rec."Site Type" := Rec."site type"::Individual;
