...
Page 75090 "Vendor Debarment card"
{
    DeleteAllowed = false;
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control12; "Vendor Debarment Voucher Line")
            {
            ...
            group("F&unctions")
            {
                ...
                action(Post)
                {
                    ...
                    begin
                        ...
                        Procurement.PostVendDebarment(Rec);
                    end;
                }
            }
    ...
    begin
        Rec."Document Type" := Rec."document type"::Debarment;
