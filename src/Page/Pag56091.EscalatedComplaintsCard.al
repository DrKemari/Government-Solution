...
Page 56091 "Escalated Complaints Card"
{
    ...
    actions
    {
        area(creation)
        {
            ...
            action("Submit Complaint")
            {
                ...
                Promoted = true;
                PromotedCategory = Process;
                ToolTip = 'Executes the Submit Complaint action.';
                trigger OnAction()
                begin
                    Rec.TestField("Solution Remarks");
                    Rec."Date Submitted" := WorkDate;
                    ...
                    SendEmailuser();
                    sms();
                    Message('Case has been resolved  and submitted to %1', Rec."Receiving Officer");
                end;
            }
        }
    }
    ...
    begin
        Usersetup.Reset;
        Usersetup.SetRange(Usersetup."User ID", Rec."Receiving Officer");
        if Usersetup.Find('-') then begin
