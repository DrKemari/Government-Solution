...
Page 72044 "Project Engineer Card"
{
    Caption = 'Project Engineer Card';
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("External Consultant"; Rec."External Consultant")
                {
                    ApplicationArea = Basic;
                }
                field("Researcher's Major"; Rec."Researcher's Major")
                {
                    ApplicationArea = Basic;
                    MultiLine = true;
                }
                field("Researcher Biography"; Rec."Researcher Biography")
                {
                    ApplicationArea = Basic;
                    MultiLine = true;
                }
    ...
    begin
        Rec."Project Engineer" := true;
        Rec."Resource Type" := Rec."resource type"::"Project Engineer";
    end;
