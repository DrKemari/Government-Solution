...
Page 85153 "Int Exam Appointment Voucher"
{
    PageType = Card;
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Int Examination Appointment";
        Rec.Description := 'Internal Examination Appointment';
