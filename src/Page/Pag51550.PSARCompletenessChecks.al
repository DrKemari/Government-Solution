...
Page 51550 "PSAR Completeness Checks"
{
    Caption = 'Programme SAR Completeness Checks';
    CardPageID = "PSAR Completeness Check";
    Editable = false;
    PageType = List;
    SourceTable = "Audit Requisition Header";
    SourceTableView = where("Document Type" = filter("SAR Feedback Voucher"));
