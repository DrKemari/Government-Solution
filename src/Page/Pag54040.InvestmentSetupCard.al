...
Page 54040 "Investment Setup Card"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Institution Nos"; Rec."Institution Nos")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Institution Nos field.';
                }
                field("Split Nos"; Rec."Split Nos")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Split Nos field.';
                }
                field("Dividend Nos"; Rec."Dividend Nos")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Dividend Nos field.';
                }
            }
        }
    }
