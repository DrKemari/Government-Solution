...
Page 85358 "EC Syllabus Feedback"
{
    Caption = 'EC Syllabus Feedback';
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control24; "EC Syllabus Topics")
            {
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action("Forward to Board")
                {
                    ...
                    PromotedIsBig = true;
                    ToolTip = 'Executes the Forward to Board action.';
                    trigger OnAction()
                    var
                    ...
                    begin
                        if Confirm(TXT001, true, Rec."Application Description") = true then begin
                            ...
                            if AccreditationApp.FindFirst then begin
                                AccreditationApp.Status := AccreditationApp.Status::"Board Approval";
