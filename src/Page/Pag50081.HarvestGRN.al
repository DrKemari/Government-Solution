...
Page 50081 "Harvest GRN"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Actual Budget Costs"; Rec."Actual Budget Costs")
                {
                    ApplicationArea = Basic;
                    Style = StrongAccent;
                    StyleExpr = true;
                    ToolTip = 'Specifies the value of the Actual Budget Costs field.';
                }
                ...
                field("Remaining Budget"; Rec."Remaining Budget")
                {
                    ...
                    Style = Attention;
                    StyleExpr = true;
                    ToolTip = 'Specifies the value of the Remaining Budget field.';
                }
                ...
                field(Harvest; Rec.Harvest)
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Harvest field.';
                }
                field("Total Project Cost"; Rec."Total Project Cost")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    ToolTip = 'Specifies the value of the Total Project Cost field.';
                }
            }
    ...
    begin
        ...
        Rec.SetRange("Date Filter", 0D, Rec."Order Date");
        Rec.CalcFields("Budgeted Amount", "Actual Budget Costs", "Budget Commitments");
