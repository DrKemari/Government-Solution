...
Page 80017 "Department Card"
{
    Caption = 'Department Card';
    PageType = Card;
    SourceTable = "Responsibility Center";
    SourceTableView = where("Operating Unit Type" = const("Department/Center"));
    ...
    actions
    {
        area(navigation)
        {
            ...
            action("Core Mandate")
            {
                ...
                Promoted = true;
                PromotedCategory = Process;
                RunObject = Page "Rc Core Mandate";
    ...
    begin
        Rec."Operating Unit Type" := Rec."operating unit type"::"Department/Center";
    end;
