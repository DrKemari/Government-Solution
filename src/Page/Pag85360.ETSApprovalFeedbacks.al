...
Page 85360 "ETS Approval Feedbacks"
{
    ApplicationArea = Basic;
    Caption = 'ETS Approval Syllabuses';
    CardPageID = "ETS Syllabus Feedback";
    Editable = false;
    PageType = List;
    SourceTable = "Evaluation Header";
    SourceTableView = where("Document Type" = filter(Development),
                            "Commitee Type" = filter("Examination Technical SubCommitee"));
    UsageCategory = Tasks;
