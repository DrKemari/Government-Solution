...
Page 54009 "Treasury Bond Card"
{
        ...
        area(creation)
        {
            ...
            action("View Interest Schedule")
            {
                ...
                begin
                    ...
                    Rec.CalcFields("Acquisition Cost");
                    if Rec."No. Of Interest Periods" <> 0 then
                    begin
            ...
            action("Partial Bond Redemption")
            {
                ...
                begin
                    ...
                    Sale."Face Value":= Rec."Face Value";
                    Sale."Document No":= Rec."No.";
                    Sale."TBond No":= Rec."FDR Number";
                    Sale.Insert(true);
                    Sale.Validate(Sale.No);
                    Sale.Validate(Sale.Institution);
                    //Purchase.RESET;
    ...
    begin
        ...
        Rec."Deposit Type" := Rec."deposit type"::Treasury;
        Rec.UnitTrust := true;
    end;
