...
Page 95310 "Auditee Draft Audit Report L"
{
    Caption = 'Auditee MAnagement Comments';
    CardPageID = "Auditee Draft Audit Report C";
    DeleteAllowed = false;
    Editable = false;
    PageType = List;
    SourceTable = "Audit Execution Header";
    SourceTableView = where("Document Type" = filter("Draft Audit Report"));
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Draft Audit Report";
    end;
}
