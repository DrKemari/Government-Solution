...
Page 65138 "Planning & Strategy  Role Cent"
{
    // CurrPage."Help And Setup List".ShowFeatured;

    Caption = 'Strategy and Planning', Comment = '{Dependency=Match,"ProfileDescription_SMALLBUSINESS"}';
    PageType = RoleCenter;
    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group("M&E")
            {
                ...
                {
                    ApplicationArea = Basic;
                    RunObject = Page "Company Policies";
                }
            }
            group("My Request")
            {
