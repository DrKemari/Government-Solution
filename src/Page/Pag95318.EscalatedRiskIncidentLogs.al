...
Page 95318 "Escalated Risk Incident Logs"
{
    CardPageID = "Risk Incident Log";
    PageType = List;
    SourceTable = "Risk Incident Log";
    SourceTableView = where("Escalated?" = const(true));
    ...
    var
        TEX000: label 'Escalation Has Been Handled And Closed Sucessfully.';
}
