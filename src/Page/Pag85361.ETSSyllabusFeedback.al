...
Page 85361 "ETS Syllabus Feedback"
{
    Caption = 'ETS Syllabus Feedback';
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control24; "ETS Syllabus Topics")
            {
    ...
    actions
    {
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action("Forward to Examination Commitee")
                {
                    ApplicationArea = Basic;
                    Image = Post;
                    Promoted = true;
                    ...
                    PromotedIsBig = true;
                    ToolTip = 'Executes the Forward to Examination Commitee action.';
                    trigger OnAction()
                    var
    ...
    begin
        ...
        Rec."Commitee Type" := Rec."commitee type"::"Examination Technical SubCommitee";
    end;
