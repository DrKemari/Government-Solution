...
Page 51524 "Analy Programme Organization"
{
    Caption = 'strengths and weaknesses on Programme Organization';
    PageType = List;
    ...
    begin
        Rec."Category Type" := Rec."category type"::"Programme Organization"
    end;
}
