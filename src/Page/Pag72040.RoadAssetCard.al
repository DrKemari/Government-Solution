...
Page 72040 "Road Asset Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group("Research Details")
            {
                ...
                field("Master Road Link ID"; Rec."Master Road Link ID")
                {
                    ApplicationArea = Basic;
                }
                field("Original Road ID"; Rec."Original Road ID")
                {
                    ApplicationArea = Basic;
                }
                field("Original Road Class"; Rec."Original Road Class")
                {
                    ApplicationArea = Basic;
                }
                field("Original Road No"; Rec."Original Road No")
                {
                    ApplicationArea = Basic;
                }
                field("Orignal Road Agency"; Rec."Orignal Road Agency")
                {
                    ApplicationArea = Basic;
                }
                field("Road Label"; Rec."Road Label")
                {
                    ApplicationArea = Basic;
                }
                field("Gazetted  Road Class"; Rec."Gazetted  Road Class")
                {
                    ApplicationArea = Basic;
                }
                ...
                field("Total Road Length(KM)"; Rec."Total Road Length(KM)")
                {
                    ApplicationArea = Basic;
                }
        ...
        area(navigation)
        {
            group("Fixed &Asset")
            {
                ...
                action(Furnitures)
                {
                    ...
                    PromotedIsBig = true;
                    PromotedOnly = true;
                    RunObject = Page "Road Furniture Inventory";
                    RunPageLink = "Road Code"=field("No."),
                                  "Road Facility Catgegory"=filter(Furniture);
                }
                action(Structures)
                {
                    ApplicationArea = Basic;
    ...
    begin
        Rec."Record Type" := Rec."record type"::"Road Asset";
    end;
