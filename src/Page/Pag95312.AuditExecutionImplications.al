...
Page 95312 "Audit Execution Implications"
{
    PageType = List;
    SourceTable = "Audit Execution Implication";
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Posted Finding Entry No."; Rec."Posted Finding Entry No.")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Posted Finding Entry No. field.';
                }
