...
/// </summary>
page 69999 "DBSL Accountant Role Center"
{
    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group("Funds Management")
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Standing Imprest Requsitions';
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = Page "Standing Imprest Requsitions";
                    ToolTip = 'Standing Imprest Requsitions';
                }
                action("Approved Standing Imprests")
                {
                    ...
                    ToolTip = 'Approved Standing Imprests';
                }
                action("Posted Standing Imprests")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Posted Standing Imprests';
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = Page "Posted Standing Imprests";
