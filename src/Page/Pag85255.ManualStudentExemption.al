...
Page 85255 "Manual Student Exemption"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Additional Exemption field.';
                }
                ...
                field("Exemption Amount"; Rec."Exemption Amount")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    ToolTip = 'Specifies the value of the Exemption Amount field.';
                }
                ...
                field("Exemption Receipt 6No."; Rec."Exemption Receipt 6No.")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    ToolTip = 'Specifies the value of the Exemption Receipt 6No. field.';
                }
    ...
    actions
    {
        area(creation)
        {
            ...
            action("Process Invoice")
            {
                ...
                begin
                    if Rec."Institution Code" = '' then begin
                        ...
                        if Confirm('Are you sure you want to process invoice for this application') = true then begin
            ...
            action("Process Receipt")
            {
                ...
                trigger OnAction()
                begin
                    if Confirm('Are you sure you want to process the receipt for this application') = true then begin
            ...
            action("Student Qualifications")
            {
                ...
                ToolTip = 'Executes the Student Qualifications action.';
            }
            ...
            group("Request Approval")
            {
                ...
                action("Mandatory Documents")
                {
                    ...
                    Visible = false;
                    ToolTip = 'Executes the Mandatory Documents action.';
                }
