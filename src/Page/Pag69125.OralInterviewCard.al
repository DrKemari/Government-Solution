...
Page 69125 "Oral Interview Card"
{
    ...
    SourceTableView = where(Status = filter("Oral&Written"));
            ...
            group("Fu&nctions")
            {
                ...
                action("Get Oral  Shortlisted Applicants")
                {
                    ...
                    begin
                        ...
                        VacancyApplicantsTable.SetRange(Status, VacancyApplicantsTable.Status::"Oral&Written");
                        if VacancyApplicantsTable.FindSet then begin

                            repeat
                                VacancyRequisitionLines.Init;
                                VacancyRequisitionLines.Type := VacancyRequisitionLines.Type::"Oral&Written";
