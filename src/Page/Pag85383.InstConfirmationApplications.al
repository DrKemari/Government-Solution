...
Page 85383 "Inst Confirmation Applications"
{
    ApplicationArea = Basic;
    Caption = 'Confirmation Applications';
    CardPageID = "InstitutionConfirmation Header";
    DeleteAllowed = false;
    InsertAllowed = false;
    ModifyAllowed = false;
    PageType = List;
    SourceTable = "Student Processing Header";
    SourceTableView = where("Document Type" = filter("Institution Confirmation"),
                            Posted = filter(false));
    UsageCategory = Tasks;
