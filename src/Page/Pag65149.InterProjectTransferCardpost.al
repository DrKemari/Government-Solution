                ...
                action(Post)
                {
                    ...
                    begin
                        ...
                        if InterfundLine.FindSet then begin
                            repeat
                                LineNumber := LineNumber + 1000;
                                FundsAccounting.FnPostInterfundCredit(JTemplate, JBatch, LineNumber, Rec."Document Date", Genline."document type"::" ", Rec.No, Rec."External Document No.", Genline."account type"::"G/L Account", InterfundLine."Transfer-From Expense G/L A/C",
                       ...
                       // FundsAccounting.FnChangeEntryToPositive(No, "Transfer-To Job No", "Transfer-To Task No", "Total Transfer Amount", "Total Transfer Amount LCY");
