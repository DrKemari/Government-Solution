...
Page 85285 "Checkers Work Ticket"
{
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Checker No"; Rec."Checker No")
                {
                    ApplicationArea = Basic;
            ...
            part(Control29; "Checkers Work Ticket Lines")
            {
    ...
    actions
    {
        area(processing)
        {
            action("Print Ticket")
            {
                ...
                PromotedIsBig = true;
                ToolTip = 'Executes the Print Ticket action.';
                trigger OnAction()
                var
                ...
                begin
                    ...
                    Report.Run(85199, true, true, Rec);
                end;
            }
            action(Post)
            {
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Checker Work Ticket";
    end;
