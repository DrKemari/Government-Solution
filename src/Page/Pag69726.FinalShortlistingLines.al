...
Page 69726 "Final Shortlisting Lines"
{
    PageType = ListPart;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                // }
                // field("App Documents Submitted"; "App Documents Submitted")
                // {
                //     ApplicationArea = Basic;
                //     ToolTip = 'Specifies the value of the App Documents Submitted field.';
                // }
                // field("Shortlisting Results"; "Shortlisting Results")
                // {
                //     ApplicationArea = Basic;
                //     ToolTip = 'Specifies the value of the Shortlisting Results field.';
                // }
                // field("Shortlisting Committee Remarks"; "Shortlisting Committee Remarks")
                // {
                //     ApplicationArea = Basic;
                //     ToolTip = 'Specifies the value of the Shortlisting Committee Remarks field.';
                // }
                ...
                // }
                // field("Interview Start Date"; "Interview Start Date")
                // {
                //     ApplicationArea = Basic;
                //     ToolTip = 'Specifies the value of the Interview Start Date field.';
                // }
                ...
                // }
                // field("Interview End Date"; "Interview End Date")
                // {
                //     ApplicationArea = Basic;
                //     ToolTip = 'Specifies the value of the Interview End Date field.';
                // }
