...
Page 85391 "Checker Attendance"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control29; "Checker Attendance Lines")
            {
        ...
        area(processing)
        {
            action("Print Attendance")
            {
                ...
                begin
                    ...
                    Report.Run(85204, true, true, Rec);
                end;
            }
            action(Post)
            {
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Checker Attendance";
    end;
