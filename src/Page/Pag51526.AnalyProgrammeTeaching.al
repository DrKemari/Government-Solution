...
Page 51526 "Analy Programme Teaching"
{
    Caption = 'strengths and weaknesses on Programme Teaching Approach';
    PageType = List;
    ...
    begin
        Rec."Category Type" := Rec."category type"::"Teaching Approaches"
    end;
}
