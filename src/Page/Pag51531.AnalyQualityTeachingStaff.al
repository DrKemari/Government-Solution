...
Page 51531 "Analy Quality Teaching Staff"
{
    Caption = 'strengths and weaknesses on Programme Teaching Staff';
    PageType = List;
    ...
    begin
        Rec."Category Type" := Rec."category type"::"Quality of Teaching Staff"
    end;
}
