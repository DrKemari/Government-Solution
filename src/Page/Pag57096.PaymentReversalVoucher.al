...
Page 57096 "Payment Reversal Voucher"
{
        ...
        area(processing)
        {
                ...
                action(Post)
                {
                    ...
                    begin
                        ...
                        */
                        ...
                        GL.Reset;
                        GL.SetRange("Document No.", Rec."Original Document No");
            ...
            action("&Navigate")
            {
                ...
                var
                    ...
                    GL: Record "G/L Entry";
                begin
                    Navigate.SetDoc(Rec."Posting Date", Rec."Original Document No");
                    Navigate.Run;
                end;
            }
    ...
    begin
        Rec."Payment Type" := Rec."payment type"::"Payment Voucher Reversal";
