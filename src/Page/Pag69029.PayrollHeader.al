        ...
        area(navigation)
        {
            ...
            group("F&unctions")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    begin
                        ...
                        //if //ApprovalsMgmt.CheckSalaryApprovalsWorkflowEnabled(Rec) then
                        //ApprovalsMgmt.OnSendSalaryForApproval(Rec);
                    end;
                }
                action(CancelApprovalRequest)
                {
                    ...
                    trigger OnAction()
                    begin
                        //ApprovalsMgmt.OnCancelSalaryApprovalRequest(Rec);
                    end;
                }
                separator(Action29)
                {
            ...
            group("Payroll Reconcilliation")
            {
                ...
                action("Attach Documents")
                {
                    ...
                    trigger OnAction()
                    begin
                        DMSManagement.FnUploadSalaryVoucherDocs(Rec."No.", 'Salary Voucher', Rec.RecordId);
                    end;
                }
            }
        }
