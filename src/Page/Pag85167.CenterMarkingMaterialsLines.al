...
Page 85167 "Center Marking Materials Lines"
{
    PageType = ListPart;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Serial No From Received"; Rec."Serial No From Received")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Serial No From Received field.';
                }
                field("Serial No. To Received"; Rec."Serial No. To Received")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Serial No. To Received field.';
                }
            }
        }
    }
