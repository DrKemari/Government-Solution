...
Page 85313 "Syllabus Review Views"
{
    ApplicationArea = Basic;
    CardPageID = "Syllabus Views Card";
    Editable = false;
    PageType = List;
    SourceTable = "Syllabus Review";
    SourceTableView = where(Status = filter("Stakeholder Views"),
                            "Stakeholders Review" = filter(Original));
    UsageCategory = Tasks;
