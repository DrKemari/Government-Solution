...
Page 95192 "Audit Project Procedure Risks"
{
    CardPageID = "Audit Project Procedure Risk";
    PageType = List;
    SourceTable = "Audit Project Procedure Risk";
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Business Risk ID"; Rec."Business Risk ID")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Business Risk ID field.';
                }
                ...
                field("Original Risk ID"; Rec."Original Risk ID")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Original Risk ID field.';
                }
