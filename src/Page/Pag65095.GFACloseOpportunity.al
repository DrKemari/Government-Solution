        ...
        area(content)
        {
            group(General)
            {
                ...
                field(Challenges; Rec.Challenges)
                {
                    ...
                    ToolTip = 'Specifies the value of the Challenges field.';
                }
                field("Lessons Learnt"; Rec."Lessons Learnt")
                {
                    ApplicationArea = Basic;
                    MultiLine = true;
                    ToolTip = 'Specifies the value of the Lessons Learnt field.';
                }
                field("Mitigating Factors"; Rec."Mitigating Factors")
                {
                    ApplicationArea = Basic;
                    MultiLine = true;
                    ToolTip = 'Specifies the value of the Mitigating Factors field.';
                }
            }
        }
    }
