...
Page 85175 "Student Reinstatement"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            group("Examination Details")
            {
                ...
                field("Reinstatement Amount"; Rec."Reinstatement Amount")
                {
                    ApplicationArea = Basic;
                }
                field("Reinstatement Receipt No."; Rec."Reinstatement Receipt No.")
                {
                    ApplicationArea = Basic;
                }
                field("Reinstatement Invoice No."; Rec."Reinstatement Invoice No.")
                {
                    ApplicationArea = Basic;
                }
        ...
        area(processing)
        {
            group("Student Case")
            {
                ...
                action("Process Payment")
                {
                    ...
                    begin
                        Rec.TestField(Email);
                        if Confirm('Are you sure you want to process payment for this re-instatement') = true then begin
                            Examination.ReinstatementCreateInvoice(Rec);
                        end
                    end;
                }
            }
