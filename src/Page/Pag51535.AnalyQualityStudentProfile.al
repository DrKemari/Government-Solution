...
Page 51535 "Analy Quality Student Profile"
{
    Caption = 'strengths and weaknesses on Programme Student Profile';
    PageType = List;
    ...
    begin
        Rec."Category Type" := Rec."category type"::"Student Profile"
    end;
}
