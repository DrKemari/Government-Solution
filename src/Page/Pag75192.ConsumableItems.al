...
Page 75192 "Consumable Items"
{
    ...
    SourceTableView = sorting("Search Description")
                      order(ascending)
                      where("IEC Materials" = const(false));
    UsageCategory = Lists;
    ...
    begin
        ...
        Rec.CalcFields("Location Code", Inventory);
        UserSetup.Get(UserId);
        Rec.FilterGroup(2);
        Rec.SetRange("Location Filter", UserSetup."Region Code");
    ...
    begin
        ...
        /*CALCFIELDS("Location Code");
            UserSetup.GET(USERID);
            FILTERGROUP(2);
            SETFILTER("Location Code",UserSetup."Region Code");
            FILTERGROUP(0);*/
        /*
        UserSetup.GET(USERID);
       // FILTERGROUP(2);
        LocationItem.RESET;
        LocationItem.SETFILTER("Location Filter",UserSetup."Region Code");
       // FILTERGROUP(0);*/
