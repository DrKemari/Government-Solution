...
Page 50054 "Internal Requisition-F-Issued2"
{
    ApplicationArea = Basic;
    Caption = 'Internal Requisitions';
    CardPageID = "Fully Issued Requisitions";
    Editable = false;
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Requisition Expense Group"; Rec."Requisition Expense Group")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Requisition Expense Group field.';
                }
                field("IR External Document No"; Rec."IR External Document No")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the IR External Document No field.';
                }
            }
        }
        area(factboxes)
