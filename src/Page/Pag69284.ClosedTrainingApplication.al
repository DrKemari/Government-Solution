...
Page 69284 "Closed Training Application"
{
    ...
    begin
        ...
        Rec.TestField("Start DateTime");
        Rec.TestField("End DateTime");
                ...
                if EmployeeScedule.FindSet then begin
                    repeat
                        ...
                        if TrainingCoursesSetup.FindFirst then begin
                            ...
                            EmployeeQualification."From Date" := TrainingRequests."Start DateTime";
                            EmployeeQualification."To Date" := TrainingRequests."End DateTime";
