...
Page 69233 "Approved Leave Application"
{
    DeleteAllowed = false;
    InsertAllowed = false;
    ModifyAllowed = false;
                ...
                action("&Post Leave Application")
                {
                    ...
                    begin
                        ...
                        if Confirm('Do you wish to notify the employee') = true then begin
                            ...
                            //    'POSTED:LEAVE APPLICATION', 'Dear' + ' ' + HREmp."First Name" + ' ' + HREmp."Last Name" + ',<BR/>' + 'The leave application' + ' ' + HRLeaveApp."Application Code" +
                            //   ' ' + 'has been posted.<BR/>The expected return date is on' + ' ' + Format(HRLeaveApp."Return Date"), true);
                            //     //SMTP.Send();
