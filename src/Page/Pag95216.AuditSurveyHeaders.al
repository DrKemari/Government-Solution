...
Page 95216 "Audit Survey Headers"
{
    CardPageID = "Audit Survey Header";
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the PreAudit Survey Invitation  No field.';
                }
                field("PostAudit Survey Invitation No"; Rec."PostAudit Survey Invitation No")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the PostAudit Survey Invitation No field.';
                }
