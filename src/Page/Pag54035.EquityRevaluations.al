    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Current Market Price"; Rec."Current Market Price")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Current Market Price field.';
                }
        ...
        area(creation)
        {
            action("Price List Import")
            {
               ...
               // RunObject = XMLport UnknownXMLport54002;
                ToolTip = 'Executes the Price List Import action.';
            }
            action("Load NSE Institutions")
            {
                ...
                Promoted = true;
                PromotedCategory = Process;
                ToolTip = 'Executes the Load NSE Institutions action.';
                trigger OnAction()
                begin
            ...
            {
                ApplicationArea = Basic;
                ToolTip = 'Executes the Post Revaluation action.';
                trigger OnAction()
                begin
