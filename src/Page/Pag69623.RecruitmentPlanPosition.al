...
Page 69623 "Recruitment Plan Position"
{
    ...
    //             {
    //                 ApplicationArea = Basic;
    //                 RunObject = Page "Recruitment Plann = ng Line";
    //                 RunPageLink = "Recruitment  = lan ID"=field("Recruitment Plan ID"),
    ...
    //                 trigger OnAction()
    //                 begin true,  = 
    //                     if   Confirm('are you sure you want  > o create a vacancy for the position %1',true,Rec."Job Title/Designation")=true then begin
    ...
    //                 //The property 'PromotedIsBig' can only be set if the property 'Promoted' is set to 'true'
    //                 //PromotedIsBig = true;
    //                 RunObject = Page "Position  = esponsibilities";
    //                 RunPageLink = "Position ID"=field("Position ID");
    //             }
    //             action(Dimensions)
    //             {
