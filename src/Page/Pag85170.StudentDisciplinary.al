...
Page 85170 "Student Disciplinary"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            group("Examination Details")
            {
                ...
                field("Commiitee Reference No."; Rec."Commiitee Reference No.")
                {
                    ApplicationArea = Basic;
                }
                field("Case Verdict"; Rec."Case Verdict")
                {
                    ApplicationArea = Basic;
                }
        ...
        area(processing)
        {
            group("Student Case")
            {
                ...
                action("Commiitee Members")
                {
                    ...
                    RunPageLink = Code = field("Disciplinary Commitee");
                }
                ...
                action(Post)
                {
                    ...
                    begin
                        Rec.TestField("Verdict Description");
                        if Confirm(TXT001) = true then begin
                            Examination.EffectCaseVerdict(Rec);
                        end
                    end;
                }
            }
