...
/// <summary>
/// Page Concluded Inst. Acc. Projects (ID 51224).
/// </summary>
#pragma implicitwith disable
Page 51224 "Concluded Inst. Acc. Projects"
{
    Caption = 'Jobs';
    CardPageID = "Job Card";
    Editable = false;
    PageType = List;
    SourceTable = Job;
    SourceTableView = where("Opportunity Reference" = filter('0'),
                            "Grant Amount" = filter(1),
                            Complete = filter(true));
    ...
    layout
    {
        ...
        area(factboxes)
        {
            ...
            part(Control25; "Job Cost Factbox")
            {
                ApplicationArea = Jobs;
                Caption = 'Job Details';
                SubPageLink = "No." = field("No.");
