...
Page 54021 "Fixed Deposit Card"
{
    ...
    layout
    {
        area(content)
        {
            group("Fixed Deposit Definition")
            {
                field("No."; Rec."No.")
                {
            ...
            action(Redeem)
            {
                ...
                begin
                    ...
                    if Confirm('Are you sure you would like to REDEEM this Money market deposit?', false) = true then begin
                        ...
                        Sale."Receipt No" := '';
                        Sale."Investment Transcation Type" := Sale."investment transcation type"::Disposal;
    ...
    begin
        ...
        Rec."Investment Type" := '04';
        Rec.Validate("Investment Type");
        Rec."Deposit Type" := Rec."deposit type"::Fixed;
