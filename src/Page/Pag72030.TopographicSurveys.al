...
Page 72030 "Topographic Surveys"
{
    ApplicationArea = Basic;
    CardPageID = "Topographic Surveys Card";
    PageType = List;
    SourceTable = "Road Study_Survey";
    SourceTableView = where("Study/Survey Type"=filter("Topographic Survey"));
    UsageCategory = Tasks;
    ...
    begin
        Rec."Study/Survey Type" := Rec."study/survey type"::"Topographic Survey";
    end;
}
