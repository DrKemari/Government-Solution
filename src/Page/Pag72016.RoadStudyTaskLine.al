    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("No.  of Final Findings"; Rec."No.  of Final Findings")
                {
                    ApplicationArea = Basic;
                }
                field("No. of Final Conclusions"; Rec."No. of Final Conclusions")
                {
                    ApplicationArea = Basic;
                }
                field("No. of Final Recommendations"; Rec."No. of Final Recommendations")
                {
                    ApplicationArea = Basic;
                }
                field("No. of Interim Results"; Rec."No. of Interim Results")
                {
                    ApplicationArea = Basic;
                }
            }
