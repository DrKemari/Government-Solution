...
Page 85338 "Consecutive Views Card"
{
    PageType = Card;
        ...
        area(processing)
        {
            ...
            group(Functions)
            {
                action("Close Collection of Views")
                {
                    ...
                    Visible = false;
                    ToolTip = 'Executes the Close Collection of Views action.';
                    trigger OnAction()
                    var
    ...
    begin
        Rec."Stakeholders Review" := Rec."stakeholders review"::Consecutive;
        Rec.Status := Rec.Status::"Stakeholder Views";
    end;
