        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    var
                        ...
                        Cashmanstp: Record "Cash Management Setup";
                    begin
                        Rec.TestField(Status, Rec.Status::Open);
                        Rec.TestField("Created By", UserId);
                        Cashmanstp.Get();
                        if (Rec."Total Amount LCY" >= Cashmanstp."Petty Cash Limit") then begin
                            Error('ERROR! The amount requested is more than the set limit of %1', Cashmanstp."Petty Cash Limit");
                        end;
                        VarVariant := Rec;
            ...
            group(Approval)
            {
                ...
                action("Attach Documents")
                {
                    ...
                    trigger OnAction()
                    begin
                        DMSManagement.FnUploadPettycashvoucherDocs(Rec."No.", 'Petty Cash', Rec.RecordId);
                    end;
                }
            }
        }
