...
Page 51534 "Analy Quality Support Staff"
{
    Caption = 'strengths and weaknesses on Programme Support Staff';
    PageType = List;
    ...
    begin
        Rec."Category Type" := Rec."category type"::"Quality of Support Staff"
    end;
}
