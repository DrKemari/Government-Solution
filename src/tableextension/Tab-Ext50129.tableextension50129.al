...
TableExtension 50129 "tableextension50129" extends "Service Item" 
{
    fields
    {
        ...
        field(55001;"Rent per square Feet";Decimal)
        {
            DataClassification = ToBeClassified;

            trigger OnValidate()
            begin
                "Quarterly Rent":=4*("Area in Square Feet"*"Rent per square Feet");
                Validate("Quarterly Rent");
            end;
        }
        field(55002;"Area in Square Feet";Decimal)
        {
            DataClassification = ToBeClassified;
        ...
        field(58056;"Quarterly Rent";Decimal)
        {
            DataClassification = ToBeClassified;
            Editable = false;
            ...
            trigger OnValidate()
            begin
                "Default Contract Value":="Quarterly Rent"*4;
                "Default Contract Cost":=("Quarterly Rent"/3);
            end;
        }
    }
