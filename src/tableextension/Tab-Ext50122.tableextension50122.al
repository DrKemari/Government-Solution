...
TableExtension 50122 "tableextension50122" extends "Responsibility Center"
{
    fields
    {
        ...
        field(80000; "Operating Unit Type"; Option)
        {
            ...
            OptionCaption = ' ,Directorate,Department,Division/Unit,County,Constituency,Branch,Board,Company-Level,CEO,Court Levels,Court Stations,Office';
            OptionMembers = " ",Directorate,"Department/Center","Division/Section",Region,Constituency,Branch,Board,"Company-Level",CEO,"Court Levels","Court Stations",Office;
        }
