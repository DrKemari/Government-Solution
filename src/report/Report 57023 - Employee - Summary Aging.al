report 57023 "Employee - Summary Aging"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Employee - Summary Aging.rdlc';
    AdditionalSearchTerms = 'customer balance,payment due';
    ApplicationArea = Basic,Suite;
    Caption = 'Employee - Summary Aging';
    UsageCategory = ReportsAndAnalysis;

    dataset
    {
        dataitem(Customer;Employee)
        {
            ...
            column(Customer_Name;Customer."First Name")
            {
            }
            column(LastName_Customer;Customer."Last Name")
            {
            }
            ...
            column(Customer_NameCaption;FieldCaption(Customer."First Name"))
            {
            }
            ...
            dataitem("Integer";"Integer")
            {
                ...
                column(Customer_Name_Control74;Customer."First Name"+' '+Customer."Last Name")
                {
                }
                ...
                var
                    DtldCustLedgEntry: Record "Detailed Employee Ledger Entry";
                begin
                    if Number = 1 then
                      Currency2.Find('-')
                    else
                    ...
                    for i := 1 to 5 do begin
                      DtldCustLedgEntry.SetCurrentKey("Employee No.","Posting Date");
                      DtldCustLedgEntry.SetRange("Employee No.",Customer."No.");
            ...
            begin
                ...
                for i := 1 to 5 do begin
                  DtldCustLedgEntry.SetCurrentKey("Employee No.","Posting Date");
                  DtldCustLedgEntry.SetRange("Employee No.","No.");
                  DtldCustLedgEntry.SetRange("Posting Date",PeriodStartDate[i],PeriodStartDate[i + 1] - 1);
    ...
    var
        ...
        Customer_Summary_AgingCaptionLbl: Label 'Employee - Summary Aging';
