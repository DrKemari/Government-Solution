...
Report 85222 "Team Leader Script1"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Team Leader Script1.rdlc';
    ...
    dataset
    {
        dataitem(HD;"Scripts Dispatch Header")
        {
            ...
            dataitem(LN;"Scripts Sampling Lines")
            {
                ...
                column(Solution_LN;LN.Solution)
                {
                }
                column(DummyA_LN;LN."Dummy A")
                {
                }
                column(DummyB_LN;LN."Dummy B")
                {
                }
                column(DummyC_LN;LN."Dummy C")
                {
                }
            }
