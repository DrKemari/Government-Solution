...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Consolidated Project Funidng R.rdlc';
    ...
    dataset
    {
        dataitem("Consolidated Project Funding R";"Consolidated Project Funding R")
        {
            ...
            column(FundingAmount_ConsolidatedProjectFundingR;"Consolidated Project Funding R"."Funding Amount")
            {
            }
            column(FundingAmountLCY_ConsolidatedProjectFundingR;"Consolidated Project Funding R"."Funding Amount(LCY)")
            {
            }
            column(EntryType_ConsolidatedProjectFundingR;"Consolidated Project Funding R"."Entry Type")
            {
            }
        }
    }
