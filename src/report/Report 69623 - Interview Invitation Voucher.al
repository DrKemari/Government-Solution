report 69623 "Interview Invitation Voucher"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Interview Invitation Voucher.rdlc';
    ...
    dataset
    {
        dataitem("Candidate Selection Header";"Candidate Selection Header")
        {
            ...
            dataitem("Candidate Shortlist Matrix";"Candidate Interview Line")
            {
                ...
                column(QualificationName_CandidateShortlistMatrix;"Candidate Shortlist Matrix"."Academic Qualification Name")
                {
                }
                column(WorkExperienceYears_CandidateShortlistMatrix;"Candidate Shortlist Matrix"."General Work Experience Yrs")
                {
                }
                column(ManagementExperienceYears_CandidateShortlistMatrix;"Candidate Shortlist Matrix"."Management Experience Yrs")
                {
                }
                ...
                column(DisabilityCertificateNo_CandidateShortlistMatrix;"Candidate Shortlist Matrix"."Disability Cert No.")
                {
                }
                ...
                column(HighestAcademicHierarchyPoi_CandidateShortlistMatrix;"Candidate Shortlist Matrix"."Highest Academic Pointer")
                {
                }
            }
        }
