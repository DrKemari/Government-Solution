report 85001 "Bulk Booking Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Bulk Booking Report.rdlc';

    dataset
    {
        dataitem("Bulk Processing Header";"Bulk Processing Header")
        {
            DataItemTableView = WHERE("Document Type"=FILTER(Booking));
            ...
            dataitem("Bulk Processing Lines";"Bulk Processing Lines")
            {
                ...
                column(SubjectCode_BulkProcessingLines;"Bulk Processing Lines"."Subject Code")
                {
                }
                column(Subject_BulkProcessingLines;"Bulk Processing Lines".Subject)
                {
                }
                column(Age_BulkProcessingLines;"Bulk Processing Lines".Age)
                {
                }
                column(Image_BulkProcessingLines;"Bulk Processing Lines".Image)
                {
                }
                column(ExaminationProjectCode_BulkProcessingLines;"Bulk Processing Lines"."Examination Project Code")
                {
                }
                column(ExaminationProjectName_BulkProcessingLines;"Bulk Processing Lines"."Examination Project Name")
                {
                }
                column(Section_BulkProcessingLines;"Bulk Processing Lines".Section)
                {
                }
                column(Part_BulkProcessingLines;"Bulk Processing Lines".Part)
                {
                }
                column(Paper_BulkProcessingLines;"Bulk Processing Lines".Paper)
                {
                }
                column(Description_BulkProcessingLines;"Bulk Processing Lines".Description)
                {
                }
                column(BookingType_BulkProcessingLines;"Bulk Processing Lines"."Booking Type")
                {
                }
            }
        }
