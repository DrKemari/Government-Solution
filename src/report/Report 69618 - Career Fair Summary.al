report 69618 "Career Fair Summary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Career Fair Summary.rdlc';
    ...
    dataset
    {
        dataitem("Vacancy Announcement";"Vacancy Announcement")
        {
            ...
            dataitem("Career Fair Attendance";"Career Fair Attendance")
            {
                DataItemLink = "Career Fair ID"=FIELD("Announcement No.");
                column(CareerFairID_CareerFairAttendance;"Career Fair Attendance"."Career Fair ID")
                {
                }
                column(LineNo_CareerFairAttendance;"Career Fair Attendance"."Line No.")
                {
                }
                column(AttendeeType_CareerFairAttendance;"Career Fair Attendance"."Attendee Type")
                {
                }
                column(RepresentativeName_CareerFairAttendance;"Career Fair Attendance"."Representative Name")
                {
                }
                column(RepresentativeEmail_CareerFairAttendance;"Career Fair Attendance"."Representative Email")
                {
                }
                column(RepresentativeTelNo_CareerFairAttendance;"Career Fair Attendance"."Representative Tel No")
                {
                }
                column(NotifiedonEmail_CareerFairAttendance;"Career Fair Attendance"."Notified on Email")
                {
                }
                column(DateTimeNotified_CareerFairAttendance;"Career Fair Attendance"."Date/Time Notified")
                {
                }
            }
        }
