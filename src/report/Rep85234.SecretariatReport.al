...
Report 85234 "Secretariat Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Secretariat Report.rdlc';
    ...
    dataset
    {
        dataitem(RSL;"Examination Results")
        {
            ...
            column(Fname;ExaminationAccount."First Name")
            {
            }
            column(Surname;ExaminationAccount.Surname)
            {
            }
            column(middlename;ExaminationAccount."Middle Name")
            {
            }
            column(PassMark;Papers."Pass Mark")
            {
            }
            ...
            //     ExaminationAccount.SetRange("Registration No.",RSL."Student Reg No.");
            //     if ExaminationAccount.FindSet then


            //     Papers.Reset;
            //     Papers.SetRange(Code,RSL.Paper);
