report 54209 "CBonds Portfolio Per Fund"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CBonds Portfolio Per Fund.rdlc';

    dataset
    {
        dataitem("Fixed Asset";"Investment Asset")
        {
            DataItemTableView = SORTING("No.") WHERE("Asset Type"=CONST("Money Market"),"Investment Type"=CONST('06'),"Deposit Type"=CONST(Corporate));
            ...
            column(CurrentValue_FixedAsset_New;"Fixed Asset"."Current Value")
            {
            }
            ...
            begin
                ...
                */
                ...
                MarketValue:="Fixed Asset"."Acquisition Cost"+"Fixed Asset"."Accrued Interest";
