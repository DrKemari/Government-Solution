...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Clustere Committee appoint.rdlc';
    ...
    dataset
    {
        dataitem("IFS Tender Committee";"IFS Tender Committee")
        {
            ...
            dataitem("IFS Tender Committe Entry";"IFS Tender Committe Entry")
            {
                DataItemLink = "Document No."=FIELD("Document No.");
                column(DocumentNo_IFSTenderCommitteEntry;"IFS Tender Committe Entry"."Document No.")
                {
                }
                column(IFSCode_IFSTenderCommitteEntry;"IFS Tender Committe Entry"."IFS Code")
                {
                }
                column(Description_IFSTenderCommitteEntry;"IFS Tender Committe Entry".Description)
                {
                }
