report 69455 "Risk Incident  Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Risk Incident  Report.rdlc';
    ...
    dataset
    {
        dataitem("Risk Incident Log";"Risk Incident Log")
        {
            ...
            dataitem("Risk Incident Log Impact R";"Risk Incident Log Impact R")
            {
                DataItemLink = "Incident No"=FIELD("Incident ID");
                column(IncidentNo_RiskIncidentLogImpactR;"Risk Incident Log Impact R"."Incident No")
                {
                }
                column(LineNo_RiskIncidentLogImpactR;"Risk Incident Log Impact R"."Line No")
                {
                }
                column(ImpactType_RiskIncidentLogImpactR;"Risk Incident Log Impact R"."Impact Type")
                {
                }
                column(Description_RiskIncidentLogImpactR;"Risk Incident Log Impact R".Description)
                {
                }
                column(UnitOfMeasure_RiskIncidentLogImpactR;"Risk Incident Log Impact R"."Unit Of Measure")
                {
                }
                column(Quantity_RiskIncidentLogImpactR;"Risk Incident Log Impact R".Quantity)
                {
                }
                column(CategoryofPartyAffected_RiskIncidentLogImpactR;"Risk Incident Log Impact R"."Category of Party Affected")
                {
                }
                column(InternalEmployeeNo_RiskIncidentLogImpactR;"Risk Incident Log Impact R"."Internal Employee No.")
                {
                }
                column(Name_RiskIncidentLogImpactR;"Risk Incident Log Impact R".Name)
                {
                }
                column(ContactDetails_RiskIncidentLogImpactR;"Risk Incident Log Impact R"."Contact Details")
                {
                }
                column(AdditionalComments_RiskIncidentLogImpactR;"Risk Incident Log Impact R"."Additional Comments")
                {
                }
            }
        }
