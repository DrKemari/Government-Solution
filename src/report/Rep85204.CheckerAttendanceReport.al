...
Report 85204 "Checker Attendance Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Checker Attendance Report.rdlc';
    ...
    dataset
    {
        dataitem(HD;"Scripts Dispatch Header")
        {
            ...
            dataitem(LN;"Checkers Ticket Lines")
            {
                ...
                column(AttendedMorningSession_LN;LN."Attended Morning Session")
                {
                }
                column(AttendedEveningSession_LN;LN."Attended Evening Session")
                {
                }
            }
