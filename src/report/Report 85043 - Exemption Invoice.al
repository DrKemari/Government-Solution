report 85043 "Exemption Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Exemption Invoice.rdlc';
    ...
    dataset
    {
        dataitem("Student Processing Header";"Student Processing Header")
        {
            ...
            dataitem("Exemption Lines";"Exemption Lines")
            {
                DataItemLink = "Header No."=FIELD("No.");
                column(LineNo_ExemptionLines;"Exemption Lines"."Line No.")
                {
                }
                column(HeaderNo_ExemptionLines;"Exemption Lines"."Header No.")
                {
                }
                column(CourseId_ExemptionLines;"Exemption Lines"."Course Id")
                {
                }
                column(Type_ExemptionLines;"Exemption Lines".Type)
                {
                }
                column(No_ExemptionLines;"Exemption Lines"."No.")
                {
                }
                column(Name_ExemptionLines;"Exemption Lines".Name)
                {
                }
                column(CurrencyCode_ExemptionLines;"Exemption Lines"."Currency Code")
                {
                }
                column(Amount_ExemptionLines;"Exemption Lines".Amount)
                {
                }
                column(AmountLCY_ExemptionLines;"Exemption Lines"."Amount LCY")
                {
                }
                column(LastModifiedDateTime_ExemptionLines;"Exemption Lines"."Last Modified Date Time")
                {
                }
                column(LastDateModified_ExemptionLines;"Exemption Lines"."Last Date Modified")
                {
                }
            }
