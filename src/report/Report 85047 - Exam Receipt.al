report 85047 "Exam Receipt"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Exam Receipt.rdlc';
    ...
    dataset
    {
        dataitem("Student Processing Header";"Student Processing Header")
        {
            ...
            column(BookingReceiptNo_StudentProcessingHeader;ReceiptNo)
            {
            }
            ...
            begin
                ...
                TodayDate:="Student Processing Header"."Posted Date";

                if "Student Processing Header"."Booking Receipt No."='' then
                  ReceiptNo:="Student Processing Header"."Payment Reference No." else
                  ReceiptNo:="Student Processing Header"."Booking Receipt No.";
            end;
        }
    }
