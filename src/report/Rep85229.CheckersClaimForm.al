...
Report 85229 "Checkers Claim Form"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Checkers Claim Form.rdlc';
    ...
    dataset
    {
        dataitem(HD;"Scripts Dispatch Header")
        {
            ...
            column(CheckingAmount_HD;HD."Checking Amount")
            {
            }
            column(TotalCheckingAmount_HD;HD."Total Checking Amount")
            {
            }
            column(Allowances_HD;HD.Allowances)
            {
            }
            column(TeamLeaderAmount_HD;HD."Team Leader Amount")
            {
            }
            ...
            column(TotalMarkingAmount_HD;HD."Total Marking Amount")
            {
            }
            column(TotalLunchAllowance_HD;HD."Total Lunch Allowance")
            {
            }
            column(TotalDaysPresent_HD;HD."Total Days Present")
            {
            }
            column(DummyAmount_HD;HD."Dummy Amount")
            {
            }
            column(MarksDistribution_HD;HD."Marks Distribution")
            {
            }
            column(MarkingScheme_HD;HD."Marking Scheme")
            {
            }
            column(ExaminerReport_HD;HD."Examiner Report")
            {
            }
            dataitem(LN;"Markers Claim Lines")
            {
                ...
                column(NoofScriptsMarked_LN;LN."No of Scripts Marked")
                {
                }
                column(Level_LN;LN.Level)
                {
                }
                column(NoofExpectedMarkedScripts_LN;LN."No. of Expected Marked Scripts")
                {
                }
                column(Amount_LN;LN.Amount)
                {
                }
            }
