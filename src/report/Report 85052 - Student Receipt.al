report 85052 "Student Receipt"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Student Receipt.rdlc';
    ...
    dataset
    {
        dataitem("Student Processing Header";"Student Processing Header")
        {
            ...
            begin
                ...
                ReceiptsHeader1.SetRange("No.","Student Processing Header"."Booking Receipt No.");
                if ReceiptsHeader1.FindLast then begin
                  TodayDate:=ReceiptsHeader1."Posted Date";
