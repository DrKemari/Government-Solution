report 80034 "Innovation Invitation  Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Innovation Invitation  Report.rdlc';

    dataset
    {
        dataitem("Innovation Solicitation";"Innovation Solicitation")
        {
            RequestFilterFields = "Invitation ID";
            ...
            column(InvitationID_InnovationSolicitation;"Innovation Solicitation"."Invitation ID")
            {
            }
