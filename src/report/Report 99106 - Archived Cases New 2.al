report 99106 "Archived Cases New 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Archived Cases New 2.rdlc';

    dataset
    {
        dataitem("Case Register";"Case Register")
        {
            DataItemTableView = WHERE(Status=CONST(Closed));
            ...
            column(Verdict_Date;"Case Register"."Verdict Date")
            {
            }
            column(Verdict_Summary;"Case Register"."Verdict Summary")
            {
            }
