report 69131 "Complaint Register"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Complaint Register.rdlc';

    dataset
    {
        dataitem("Cases Management";"Cases Management")
        {
            DataItemTableView = WHERE(Enquiry=FILTER(false));
            RequestFilterFields = Status;
            column(TurnAroundTime_CasesManagement;"Cases Management"."Turn Around Time")
            {
            }
