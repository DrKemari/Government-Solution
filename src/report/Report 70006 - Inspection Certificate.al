...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Inspection Certificate.rdlc';
    ...
    dataset
    {
        dataitem("Inspection Header1";"Inspection Header1")
        {
            ...
            column(DeliveryNoteNo_InspectionHeader1;"Inspection Header1"."Delivery Note No.")
            {
            }
            ...
            dataitem(Inspection_Lines1_Line_No;"Commitee Members")
            {
                DataItemLink = "Appointment No"=FIELD("Commitee Appointment No");
                DataItemTableView = SORTING("Appointment No","Employee No");
                column(RefNo_InspectionLines1LineNo;Inspection_Lines1_Line_No."Ref No")
                {
                }
                column(Commitee_InspectionLines1LineNo;Inspection_Lines1_Line_No.Commitee)
                {
                }
                column(EmployeeNo_InspectionLines1LineNo;Inspection_Lines1_Line_No."Employee No")
                {
                }
                column(Name_InspectionLines1LineNo;Inspection_Lines1_Line_No.Name)
                {
                }
                column(AppointmentNo_InspectionLines1LineNo;Inspection_Lines1_Line_No."Appointment No")
                {
                }
                column(Chair_InspectionLines1LineNo;Inspection_Lines1_Line_No.Chair)
                {
                }
                column(Secretary_InspectionLines1LineNo;Inspection_Lines1_Line_No.Secretary)
                {
                }
                column(sign;UserSetupComm.Picture)
                {
                }
                ...
                begin
                    UserSetupComm.Reset;
                    UserSetupComm.SetRange("Employee No.",Inspection_Lines1_Line_No."Employee No");
                    if UserSetupComm.FindSet then
                      UserSetupComm.CalcFields(Picture);
                end;
            }
