report 54203 "Equities Report Per Fund"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Equities Report Per Fund.rdlc';
    ...
    dataset
    {
        dataitem("Fixed Asset";"Investment Asset")
        {
            ...
            column(STRSUBSTNO__REVALUATION_OF__EQUITY__INVESTMENTS_AS_AT___1___EndDate_;StrSubstNo('REVALUATION OF  EQUITY  INVESTMENTS AS AT  %1', EndDate))
            {
            }
