report 54204 "TBonds Portfolio Per Fund"
{
    DefaultLayout = RDLC;
    RDLCLayout = './TBonds Portfolio Per Fund.rdlc';

    dataset
    {
        dataitem("Fixed Asset";"Investment Asset")
        {
            DataItemTableView = SORTING("No.") WHERE("Asset Type"=CONST("Money Market"),"Investment Type"=CONST('06'),"Deposit Type"=CONST(Treasury));
