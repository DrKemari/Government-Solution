...
Report 50097 "Purchase Requisition"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(PPTotalBudget_PurchaseHeader; "PP Total Budget")
            {
            }
            column(PPFundingSourceID_PurchaseHeader; "PP Funding Source ID")
            {
            }
            column(PPPlanningCategory_PurchaseHeader; "PP Planning Category")
            {
            }
            column(PPSolicitationType_PurchaseHeader; "PP Solicitation Type")
            {
            }
            column(PPTotalCommitments_PurchaseHeader; "PP Total Commitments")
            {
            }
            column(PPTotalActualCosts_PurchaseHeader; "PP Total Actual Costs")
            {
            }
            ...
            column(Branch; "Purchase Header"."Department Name")
            {
            }
            ...
            column(JobName_PurchaseHeader; "Purchase Header"."Budgeted  Name")
            {
            }
            ...
            column(JobNo_PurchaseHeader; "Purchase Header"."Budget Item")
            {
            }
            ...
            column(User1; UserSetup."Employee Name")
            {
            }
            ...
            column(User2; UserSetup1."Employee Name")
            {
            }
            column(User3; UserSetup2."Employee Name")
            {
            }
            column(SenderDate; MAccDAte)
            {
            }
            column(Requestor; "Purchase Header"."Request-By Name")
            {
            }
            column(RequestorSign; UserSetup6.Picture)
            {
            }
            ...
            column(User1Sign; UserSetup.Picture)
            {
            }
            column(User2Sign; UserSetup1.Picture)
            {
            }
            column(User3Sign; UserSetup2.Picture)
            {
            }
            ...
            column(PreparedBy_Signature; Employees."User Signature")
            {
            }
            ...
            column(PreparedBy_Signature1; UserSetup6.Picture)
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(Vote_Item; PurchLine."Vote Item")
                        {
                        }
                        column(VAmount; PurchLine."Vote Amount")
                        {
                        }
                        column(Bcomitments; PurchLine."Budget Commitments")
                        {
                        }
                        column(Afunds; PurchLine."Available Funds")
                        {
                        }
                        column(Atdate; PurchLine."Actual To Date")
                        {
                        }
            ...
            trigger OnAfterGetRecord()
            begin
                "Purchase Header".CalcFields("Budget Item", "Budgeted Amount", "Available Funds", "Actual Budget Costs", "Budget Commitments");
                ...
                UserSetup6.Reset;
                UserSetup6.SetRange("Employee No.", "Purchase Header"."Request-By No.");
                if UserSetup6.FindSet then begin
                    UserSetup6.CalcFields(Picture);
                    UserSetup6.CalcFields(Picture);
                end;
                //Requestor
                Employees.Reset;
                Employees.SetRange("No.", "Purchase Header"."Request-By No.");
                if Employees.FindSet then begin
                    Employees.CalcFields("User Signature");
                end;
    ...
    var
        ...
        DocText: Text;
        Text0003: label 'THIS DOCUMENT IS NOT FULLY APPROVED! PLEASE CHECK';
        UserSetup6: Record "User Setup";
        Requestor: Code[50];
        RequestorSign: Record "User Setup";
