report 85083 "Attendance RegisterV1"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Attendance RegisterV1.rdlc';
                        ...
                        //      IF CenterBookingEntries.FINDFIRST THEN BEGIN
                                      ...
                                      if ExamBookingEntries.FindSet then begin
                                        StatusValue[No,1]:=' ';
                                          ...
                                          ExemptionEntries.SetRange(Remove,false);
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    ShowMandatory = true;
                    TableRelation = Courses WHERE (Type=FILTER(<>Diploma));
                }
            }
        }
