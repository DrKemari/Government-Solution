report 59099 "Authority To Incur Expenditure"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Authority To Incur Expenditure.rdlc';
    ...
    dataset
    {
        dataitem(Payments;Payments)
        {
            ...
            column(TitleLblCaption;TitleLblCaption)
            {
            }
            column(RegionalManagerName_Payments;Payments."Regional Manager Name")
            {
            }
    ...
    var
        ...
        i: Integer;
        TitleLblCaption: Label 'AUTHORITY TO INCUR EXPENDITURE (AIE)';
}
