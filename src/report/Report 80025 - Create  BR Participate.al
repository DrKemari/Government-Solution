report 80025 "Create  BR Participate"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Create  BR Participate.rdlc';

    dataset
    {
        dataitem("Examination Account";"Examination Account")
        {
            RequestFilterFields = "Course ID","Current Examination Sitting","Registration No.";
        }
        dataitem(Customer;Customer)
        {
            DataItemLink = "No."=FIELD("Student Cust No.");
            DataItemLinkReference = "Examination Account";
