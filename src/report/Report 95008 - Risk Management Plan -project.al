report 95008 "Risk Management Plan -project"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Risk Management Plan -project.rdlc';
    ...
    dataset
    {
        dataitem("Risk Management Plan";"Risk Management Plan")
        {
            ...
            column(COPrincipalInvestigator_RiskManagementPlan;"Risk Management Plan"."CO -  Principal Investigator")
            {
            }
