...
Report 50000 "Local Order"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(ServiceMessage; ServiceMessage)
            {
            }
            column(ProcurementType_PurchaseHeader; "Purchase Header"."Procurement Type")
            {
            }
            column(MessageCaptionLbl; MessageCaptionLbl)
            {
            }
            ...
            begin
                ...
                //added by Muraya 07/01/2021
                PurchaseHeader.Reset;
                PurchaseHeader.SetRange("No.", "Purchase Header"."No.");
                if "Purchase Header".FindFirst then begin
                    PT := "Purchase Header"."Procurement Type";
                    if PT = 'SERVICES' then
                        ServiceMessage := 'The final invoice will be based on the actual service provided and approved by KASNEB';
                end else begin
                    ServiceMessage := '';
                end;
    ...
    var
        ...
        MessageCaptionLbl: label 'The price is bound to change as per suppliers invoice';
        ServiceMessage: Text;
