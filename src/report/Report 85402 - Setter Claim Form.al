report 85402 "Setter Claim Form"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Setter Claim Form.rdlc';
    ...
    dataset
    {
        dataitem("Setter Header";"Setter Header")
        {
            ...
            dataitem("Disclosure Paper Submitted";"Disclosure Paper Submitted")
            {
                ...
                column(QuestionPaper_DisclosurePaperSubmitted;"Disclosure Paper Submitted"."Question Paper")
                {
                }
                column(SuggestedSolution_DisclosurePaperSubmitted;"Disclosure Paper Submitted"."Suggested Solution")
                {
                }
