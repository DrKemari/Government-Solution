report 54206 "Treasury Bills Per Fund"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Treasury Bills Per Fund.rdlc';

    dataset
    {
        dataitem("Fixed Asset";"Investment Asset")
        {
            DataItemTableView = SORTING("No.") WHERE("Asset Type"=CONST("Money Market"),"Investment Type"=CONST('05'));
            RequestFilterFields = "No.","Issue Date","Investment Date","Date Filter","Fund Code","Custodian Code";
