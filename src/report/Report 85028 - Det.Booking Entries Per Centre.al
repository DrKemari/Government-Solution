report 85028 "Det.Booking Entries Per Centre"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Det.Booking Entries Per Centre.rdlc';
    Caption = 'Detailed Booking Entries Per Centre';

    dataset
    {
        dataitem("Exam Booking Entries";"Exam Booking Entries")
        {
            RequestFilterFields = "Exam Center",Examination,"Exam Sitting";
