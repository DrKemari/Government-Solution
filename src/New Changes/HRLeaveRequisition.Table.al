Table 50029 "HR Leave Allocation Request"
{
    ...
    fields
    {
                ...
                if Status = Status::Approved then begin
                    ...
                    if CurrCalender.FindFirst() then begin
                        ...
                        if leaveCal.Find('-') then
                            LeavAllc.Init();
                        if hrSetup.Get() then
                            LeavAllc."Leave Period" := hrSetup."Base Calender Code";
        ...
        {
            OptionMembers = Normal,"Re-Imbursement","Time Off Lie","Paternity","Maternity","Carry Forward";
        }
    ...
    var
        leave_types: Record "Leave Types";
        dates: Record Date;
    begin
    end;
