...
/// <summary>
/// Codeunit NavXtenderAddLink (ID 50011).
/// </summary>
Codeunit 50011 "NavXtenderAddLink"
{
    ...
    var
        ...
        ltcStoreReq: label 'Store Requisition';
        ...
        ltcPurchaseReq: label 'Purchase Requisition Header';
    ...
    begin
        ...
        case ptxtPageName of
            ...
            ItcLeaveApplication:
                liTableID := Database::"HR Leave Application";
            ltcJobApplications:
            ...
            ltcStoreReq:
                begin
                    liTableID := Database::"Purchase Header"; //38
                    ltxtPrimaryKey := '6,' + ptxtRecordText; //6 = Store requisition
                end;
            ltcPurchaseReq:
                begin
                    liTableID := Database::"Purchase Header"; //38
                    ltxtPrimaryKey := '7,' + ptxtRecordText; //7 = purchase requisiton
                end;
            ...
            // ltcDeposit:
            //     liTableID := Database::Table10140; //10140
            // ltcPostedDeposit:
            //     liTableID := Database::Table10143; //10143
            ltcWorkCenterCard:
