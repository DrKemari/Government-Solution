...
Codeunit 85005 "Student management"
{
    ...
    var
        ...
        FILESPATH2: label 'C:\inetpub\wwwroot\StudentPortalLive\downloads\invoice\';
        FILESPATH: label 'C:\inetpub\wwwroot\StudentPortalLive\downloads\receipt\';
        FILESPATH4: label 'C:\inetpub\wwwroot\StudentPortalLive\downloads\Rename\';
        FILESPATH3: label 'C:\inetpub\wwwroot\StudentPortalLive\downloads\proforma\';
        FILESPATH6: label 'C:\inetpub\wwwroot\StudentPortalLive\downloads\test\';
        FILESPATH1: label 'C:\inetpub\wwwroot\StudentPortalLive\downloads\withdrawal\';
        FILESPATH7: label 'C:\inetpub\wwwroot\StudentPortalLive\downloads\timetable\';
        FILESPATH8: label 'C:\inetpub\wwwroot\StudentPortalLive\downloads\studentTimetable\';
        FILESPATH9: label 'C:\inetpub\wwwroot\StudentPortalLive\downloads\SubmitInvoice\';
        FILESPATH10: label 'C:\inetpub\wwwroot\StudentPortalLive\downloads\ExemptionLetter\';
        FILESPATH11: label 'C:\inetpub\wwwroot\StudentPortalLive\downloads\BooingInvoice\';
        FILESPATH12: label 'C:\inetpub\wwwroot\StudentPortalLive\downloads\RenewalInvoice\';
        ...
        Body: Text;
        FileName: Text;
        FILESPATH13: label 'C:\inetpub\wwwroot\StudentPortalLive\downloads\ResultSlip\';
        ExaminationResults: Record "Examination Results";
        DynasoftPortalUser: Record "Dynasoft Portal User";
        FILESPATH14: label 'C:\inetpub\wwwroot\StudentPortalLive\DeffermentInvoice\';
    ...
    begin
        ...
        if StudentProcessingHeader.FindFirst then begin
            repeat
                fileName := '\\184.174.39.195\HRMPEBLive\Student Processing Header\' + studentNo + '\' + studentNo + '.jpg';
                if FILE.Exists(fileName) then begin
    ...
    begin
        ...
        if SalesInvoiceHeader.FindSet then begin
            ...
            if FILE.Exists(FILESPATH2 + appNo + '.pdf') then begin
                ...
                Report.SaveAsPdf(1303, FILESPATH2 + appNo + '.pdf', SalesInvoiceHeader);
            ...
            If levelTable.findset THEN BEGIN                
                ...
                repeat
                    ...
                    if courseCount = levelCount THEN BEGIN
                        ...
                        StudentLines1."Booking Type" := StudentLines1."booking type"::Section;
