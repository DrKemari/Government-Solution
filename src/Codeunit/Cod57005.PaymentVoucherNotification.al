        ...
        if PVRec.Find('-') then
            repeat
                ...
                if PVLines.FindFirst then begin
                    PVRec.CalcFields("Total Amount LCY", "Total Net Amount", "Total VAT Amount", "Total Witholding Tax Amount",
                    ...
                    if VendorRec."E-Mail" <> '' then begin
                        ...
                        //SMTP.Create(COMPANYNAME, CompInfo."E-Mail", VendorRec."E-Mail", PVRec."Payment Narration",
                       // StrSubstNo(Text000, PVRec.Payee, PVRec."Total Amount LCY", PVRec."Total Retention Amount", PVRec."Total VAT Amount",
