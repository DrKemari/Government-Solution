...
Codeunit 70000 "Procurement Processing"
{
    ...
    begin
        ...
        if not IFS.FindSet then begin
            IFS.Init;
            IFS.Code := NoSeriesMgt.GetNextNo(ProcSetup."ITT No. Series", Today, true);
    ...
    begin
        ...
        if nobids < 3 then begin
            Error('The number of Bids submitted must be Three or more');
        end;
        if Bids.FindSet then begin
            repeat
    ...
    begin
        ...
        if RFQReqVendors.FindSet then begin
            repeat
                ...
                FileDirectory := 'C:\DOCS\Request.pdf';
                FileName := 'Request.pdf';
                FileDirectoryX := '\\41.89.47.15\CUENAV_BACKUP\CUENAV_Documents\' + COMPANYNAME + '\Direct Procurement Card\' + IFS.Code + '\';
                ...
                if IFSList.FindSet then begin
                    ...
                    if RFQReqVendors1.FindSet then begin
                        ...
                        Report.SaveAsPdf(70151, FileDirectory, RFQReqVendors1);
                    end;
                end;
                if CustEmail = '' then
                    exit;
