...
Table 72132 "Road Work Program"
{
   ...
   // LookupPageID = "Global Budget All";
    ...
    fields
    {
        ...
        field(4; "Gloabal Budget Book ID"; Code[20])
        {
            ...
            TableRelation = if ("Road Project Category" = filter("Maitenance Works")) "Road Work Program".Code where("Road Project Category" = filter("Maitenance Works"),
                                                                                                                    "Document Type" = filter("Global Budget Book"))
            else
            if ("Road Project Category" = filter("Construction Works")) "Road Work Program".Code where("Road Project Category" = filter("Construction Works"),
                                                                                                                                                                                                                   "Document Type" = filter("Global Budget Book"))
            else
            if ("Road Project Category" = filter("Studies and Surveys")) "Road Work Program".Code where("Document Type" = filter("Global Budget Book"),
                                                                                                                                                                                                                                                                                                                   "Road Project Category" = filter("Studies and Surveys"));
                ...
                if FinancialYearCode.FindSet then begin
                  ...
                  //  FinancialYearCode.TestField("G/L Budget");
                   ...
                   // "Financial Budget ID" := FinancialYearCode."G/L Budget";
                    if "Road Project Category" = "road project category"::"Maitenance Works" then
       ...
       //     CalcFormula = sum("Project Road Link"."Workplanned Length(KM)" where("Global Budget Book Code" = field(Code)));
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = if ("Road Project Category" = const("Maitenance Works")) "Road Work Program".Code where("Document Type" = const("Global Budget Book"),
                                                                                                                   "Approval Status" = const(Released))
            else
            if ("Road Project Category" = const("Construction Works")) "Road Work Program".Code where("Document Type" = const("Global Budget Book"),
                                                                                                                                                                                                                 "Approval Status" = const(Released));
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,MAINTENANCE, CONSTRUCTION, SURVEY/STUDY';
            OptionMembers = " ",MAINTENANCE," CONSTRUCTION"," SURVEY/STUDY";
        }
        ...
        {
          //  CalcFormula = sum("Road WorkPlan Package"."Total Project Cost Inc. VAT" where("Road Work Program ID" = field(Code)));
            Editable = false;
            FieldClass = FlowField;
        }
    ...
    begin
        ...
        //     if "Road Project Category" = "road project category"::"Maitenance Works" then begin
        //         if Code = '' then begin
        ...
        // if "Document Type" = "document type"::"Schedule Of Projects" then begin
        //     if "Road Project Category" = "road project category"::"Studies and Surveys" then begin
        //         if Code = '' then begin
        //             RoadsManagementSetup.Get;
        ...
        // if "Document Type" = "document type"::"Schedule Of Projects" then begin
        //     if "Road Project Category" = "road project category"::"Construction Works" then begin
        //         if Code = '' then begin
        //             RoadsManagementSetup.Get;
      ...
      //  RoadAuthority.SetRange(RoadAuthority."Current Road Agency", true);
        ...
        if ProcurementPlan.FindSet then
            "Procurement Plan ID" := ProcurementPlan.Description;
    ...
    // var
    //     RoadProgramLines: Record "Existing Road WP Package";
    // begin
    //     if GuiAllowed then
