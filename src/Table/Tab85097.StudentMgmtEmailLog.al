...
Table 85097 "Student Mgmt E-mail Log"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = ' ,Registration,Exemption,Booking,Renewal,Receipt,Invoice,Center';
            OptionMembers = " ",Registration,Exemption,Booking,Renewal,Receipt,Invoice,Center;
        }
