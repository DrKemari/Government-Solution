...
Table 70162 "Bid Past Experience"
{
    Caption = 'Contact';
    ...
    fields
    {
        ...
        field(29;"Assignment/Project Name";Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(30;"Project Scope Summary";Text[250])
        {
            DataClassification = ToBeClassified;
        ...
        field(37;"Project Completion % (Value)";Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(38;"Project Completion % (Work)";Decimal)
        {
            Caption = 'Project Completion % (Work Done)';
            DataClassification = ToBeClassified;
            Description = 'Project Completion % (Work Done)';
        }
    }
    ...
    fieldgroups
    {
        fieldgroup(DropDown;"Document Type","No.",City,"Phone No.")
        {
        }
        fieldgroup(Brick;"Document Type","No.",City,"Phone No.")
        {
        }
    }
