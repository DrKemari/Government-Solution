...
Table 69070 "Temporary Employee"
{
    ...
    fields
    {
        ...
        {
            //  CalcFormula = lookup("ManPower Planning Lines"."Task No" where ("Entry No"=field(Position)));
            Caption = 'Job Title';
            Editable = true;
        ...
        {
            TableRelation = "Employee Bank AccountXT"."Bank Branch No." where(Code = field("Employee's Bank"));
        ...
        {
            TableRelation = "Employee Bank AccountXT";
