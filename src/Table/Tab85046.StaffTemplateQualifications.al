...
Table 85046 "Staff Template Qualifications"
{
    DrillDownPageID = "Template Qualifications";
    LookupPageID = "Template Qualifications";
    ...
    keys
    {
        key(Key1;"Line No.","Staff Template ID","Staff Role Code")
        {
            Clustered = true;
        }
    }
