...
Table 95241 "Audit Execution Implication"
{
    ...
    fields
    {
        ...
        field(29;"Implication ID";Integer)
        {
            AutoIncrement = true;
            DataClassification = ToBeClassified;
        }
    ...
    keys
    {
        key(Key1;"Document Type","Document No.","Engagement ID","Checklist ID","Finding ID","Implication ID")
        {
            Clustered = true;
        }
    }
