...
Table 70075 "Vendor Professional Staff"
{
    Caption = 'Contact';
    ...
    fields
    {
        ...
        field(3; "Staff Name"; Code[100])
        {
            Caption = 'Staff Name';
        }
        field(4; Proffesion; Text[50])
        {
            Caption = 'Proffesion';
        }
        field(5; "Current Designation"; Text[100])
        {
        ...
        field(25; "Joining Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(26; "Years With the Firm"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(27; "Staff Number"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(28; "Staff Category"; Option)
        {
            DataClassification = ToBeClassified;
    ...
    keys
    {
        key(Key1; "Entry No.", "Staff Number")
        {
            Clustered = true;
        }
        key(Key2; "Staff Name")
    ...
    fieldgroups
    {
        fieldgroup(DropDown; "Entry No.", "Vendor No.", City, "Phone No.")
        {
        }
        fieldgroup(Brick; "Entry No.", "Vendor No.", City, "Phone No.")
        {
        }
    }
