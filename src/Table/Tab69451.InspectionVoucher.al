...
Table 69451 "Inspection Voucher"
{
    ...
    fields
    {
        ...
        field(4;"OSH Plan Calendar ID";Integer)
        {
            ...
            TableRelation = "HSE Plan Calendar"."Line No." where ("Plan ID"=field("OSH Management Plan ID"),
                                                                  "OSH Activity Type"=filter("OSH Inspection"));
        ...
        field(39;"Inspection Type";Option)
        {
            DataClassification = ToBeClassified;
            OptionMembers = " ","OSH Inspection","Project Supervision";
        }
        field(40;"Inspection Template";Code[50])
        {
            DataClassification = ToBeClassified;
    ...
    keys
    {
        key(Key1;"Drill ID","Inspection Type")
        {
            Clustered = true;
        }
    }
    ...
    begin
         ...
         HealthSafetySetup.TestField("OSH Inspection Report Nos.");
         NoSeriesManagement.InitSeries(HealthSafetySetup."OSH Inspection Report Nos.",xRec."No Series",0D,"Drill ID","No Series");
         end;
        "Document Date":=Today;
        Status:=Status::Open;
        "Created By":=UserId;
