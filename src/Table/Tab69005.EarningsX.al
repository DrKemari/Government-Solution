...
Table 69005 "EarningsX"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = 'Normal Earning,Owner Occupier,Home Savings,Low Interest,Tax Relief,Insurance Relief,PWD Relief';
            OptionMembers = "Normal Earning","Owner Occupier","Home Savings","Low Interest","Tax Relief","Insurance Relief","PWD Relief";
        }
        ...
        field(50007;"Currency Code";Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(50008;"Status Filter";Option)
        {
            Caption = 'Status';
            FieldClass = FlowFilter;
            OptionCaption = 'Active,Inactive,Terminated,Retired,Under Disciplinary Action';
            OptionMembers = Active,Inactive,Terminated,Retired,"Under Disciplinary Action";
        }
    }
