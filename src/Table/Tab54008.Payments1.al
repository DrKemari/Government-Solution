    ...
    fields
    {
        ...
        field(13;"Account No.";Code[20])
        {
            ...
            TableRelation = if ("Account Type"=const("G/L Account")) "G/L Account"
                            ...
                            else if ("Account Type"=const("Fixed Asset")) "Investment Asset" where ("Asset Type"=field("Investment Type"))
        ...
        {
           // TableRelation = "Bank Account"."No." where (Field53000=field("Bank Type"));
        ...
        field(60;"Price Per Share";Decimal)
        {
            ...
            begin
                ...
                if Amount>RemainingAmt then Error
