...
Table 54001 "Investment Asset"
{
    ...
    fields
    {
        ...
        field(50012;"Real Estate Manager";Code[20])
        {
            ...
            trigger OnValidate()
            begin
                if VendorRec.Get("Real Estate Manager") then
                begin
        ...
        field(50146;Sector;Code[10])
        {
            TableRelation = if ("Asset Type"=const(Equity)) "Equity Sectors"."Sector Code" where (Type=const(Equity))
                            else if ("Asset Type"=const("Money Market")) "Equity Sectors"."Sector Code" where (Type=const(MMarket));
    ...
    begin
        ...
        */
        ...
        if "Asset Type"="asset type"::Property then
        begin
        if "No." = '' then begin
          InvestmentSetup.Get;
        ...
        if "Asset Type"="asset type"::Equity then
        begin
        ...
        if "Asset Type"="asset type"::"Unit Trust" then
        begin
        if "No." = '' then begin
          InvestmentSetup.Get;
