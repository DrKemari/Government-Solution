...
Table 80191 "Plog Lines"
{
    ...
    fields
    {
        ...
        field(2; "Initiative No."; Code[100])
        {
            ...
            if ("Activity Type" = const("Secondary Activity")) "Secondary PC Objective"."Initiative No." where("Workplan No." = field("Personal Scorecard ID"))
            else
            if ("Activity Type" = const("JD Activity")) "PC Job Description"."Line Number" where("Workplan No." = field("Personal Scorecard ID"));
