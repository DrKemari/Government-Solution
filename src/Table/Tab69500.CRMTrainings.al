...
Table 69500 "CRM Trainings"
{
   // DrillDownPageID = UnknownPage55635;
   // LookupPageID = UnknownPage55635;
        ...
        field(1;"Code";Code[20])
        {
            ...
            begin
                if Code <> xRec.Code then begin
                  SalesSetup.Get;
                  NoSeriesMgt.TestManual(SalesSetup."Training Nos");
                  "No. Series" := '';
                end;
            end;
        }
    ...
    begin
        if Code = '' then begin
          SalesSetup.Get;
          SalesSetup.TestField(SalesSetup."Training Nos");
          NoSeriesMgt.InitSeries(SalesSetup."Training Nos",xRec."No. Series",0D,Code,"No. Series");
        end;
    end;
