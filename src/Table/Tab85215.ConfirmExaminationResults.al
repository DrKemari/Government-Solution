...
Table 85215 "Confirm Examination Results"
{
    ...
    fields
    {
        ...
        field(28; "Issue Confirmation"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(29; Comments; Text[2000])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(31; "Record Type"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,Examination Result,Exemption';
            OptionMembers = " ","Examination Result",Exemption;
        }
        field(32; "Exemption Reference Doc No"; Code[100])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    keys
    {
        key(Key1; "Line No.", No, "Student Reg No.", "Entry No")
        {
            Clustered = true;
        }
    }
