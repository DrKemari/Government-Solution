...
Table 85117 "Marksheet Qn Results"
{
    ...
    fields
    {
        ...
        field(8; Results; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(9; "Marksheet No"; Code[30])
        {
            DataClassification = ToBeClassified;
        }
        field(10; "Student Reg No"; Code[30])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    keys
    {
        key(Key1; "Paper Code", "Question No", "Marksheet No", "Student Reg No")
        {
            Clustered = true;
        }
    }
