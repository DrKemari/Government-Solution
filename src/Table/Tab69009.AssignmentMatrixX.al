    ...
    fields
    {
            ...
            begin
                 if Empl.Get("Employee No") then
                   ...
                   begin
                     ...
                     "Currency Code":=Empl."Currency Code";
                   ...
                   if Type=Type::Payment then begin
                     if Payments.Get(Code) then
                       begin
                        ...
                        "KRA Classification":=Payments."KRA Classification";
                ...
                //              END;
                   ...
                   Empl.CalcFields(Empl.Basic,"Retirement Contribution","SSF Employer to Date");
                    ...
                    //added 08/08/19 for excess pension
                         ...
                         /*IF Deductions."Calculate Excess Pension" = TRUE THEN
                          BEGIN
                            AssignMatrix.INIT;
                            AssignMatrix.Code := HRSetup."Excess Pension Code";
                            AssignMatrix.VALIDATE( AssignMatrix.Code);
        ...
        field(30;"No. of Units";Decimal)
        {
            ...
            begin
                   ...
                   //HRSetup."Company overtime hours"
                   end;
        ...
        field(50005;MainLoanCode;Code[20])
        {
        ...
        field(50007;Status;Option)
        {
            ...
            FieldClass = FlowField;
            OptionMembers = Active,Inactive,Terminated,Retired,"Under Disciplinary Action",Deceased;
        }
        ...
        field(65000;"Job No";Code[50])
        {
            DataClassification = ToBeClassified;
            TableRelation = Job."No.";
        }
        field(65001;"Job Task No";Code[50])
        {
            DataClassification = ToBeClassified;
        ...
        field(65003;"Currency Code";Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(65004;"Amount (FCY)";Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(65005;"Exchange Rate";Decimal)
        {
            DataClassification = ToBeClassified;

            trigger OnValidate()
            begin
                ExchangeDate:="Payroll Period";
                if "Currency Code"<>'' then
                  "Exchange Rate":=CurrencyExchangeRate.ExchangeRate(ExchangeDate,"Currency Code")
                else
                  "Exchange Rate":=1;
                "Amount (FCY)":=Amount;
                Amount:="Amount (FCY)"*"Exchange Rate";
            end;
        }
    }
