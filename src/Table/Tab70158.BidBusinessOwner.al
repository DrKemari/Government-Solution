...
Table 70158 "Bid Business Owner"
{
    ...
    fields
    {
        ...
        field(12;"ID/Passport No.";Code[30])
        {
        }
    ...
    fieldgroups
    {
        fieldgroup(DropDown;"Document Type","Entry No.",City,"Phone No.")
        {
        }
        fieldgroup(Brick;"Document Type","Entry No.",City,"Phone No.")
        {
        }
    }
