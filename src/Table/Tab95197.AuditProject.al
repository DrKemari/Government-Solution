    ...
    fields
    {
        ...
        field(16;"Primary Auditee ID";Code[20])
        {
            ...
            TableRelation = if ("Auditee Type"=filter("Company-Level")) "Responsibility Center".Code where ("Operating Unit Type"=filter("Company-Level"),
                                                                                                            ...
                                                                                                            else if ("Auditee Type"=filter(Board)) "Responsibility Center".Code where ("Operating Unit Type"=filter(Board),
                                                                                                                                                                                       "Blocked?"=filter(false))
                                                                                                                                                                                       else if ("Auditee Type"=filter(Directorate)) "Responsibility Center".Code where ("Operating Unit Type"=filter(Directorate),
                                                                                                                                                                                                                                                                        "Blocked?"=filter(false))
                                                                                                                                                                                                                                                                        else if ("Auditee Type"=filter(Department)) "Responsibility Center".Code where ("Operating Unit Type"=filter("Department/Center"),
                                                                                                                                                                                                                                                                                                                                                        "Blocked?"=filter(false))
                                                                                                                                                                                                                                                                                                                                                        else if ("Auditee Type"=filter("Section/Team")) "Responsibility Center".Code where ("Operating Unit Type"=filter("Division/Section"),
                                                                                                                                                                                                                                                                                                                                                                                                                                            "Blocked?"=filter(false))
                                                                                                                                                                                                                                                                                                                                                                                                                                            else "Responsibility Center".Code;
