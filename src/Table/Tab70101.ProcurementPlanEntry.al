...
Table 70101 "Procurement Plan Entry"
{
    ...
    fields
    {
        ...
        field(45; "Qty(1st Quater)"; Integer)
        {
            ...
            var
                myInt: Integer;
            begin
                IF Quantity < ("Qty(1st Quater)" + "Qty(2nd Quarter)" + "Qty(3rd Quarter)" + "Qty(4th Quarter)") THEN BEGIN
                    ERROR('Error!, Kindly Align the Planning Quantities Correctly');
                END;
                "Amount(1st Quarter)":="Qty(1st Quater)"*"Unit Cost";
                Validate("Amount(1st Quarter)");
            end;
        }
        field(46; "Amount(1st Quarter)"; Decimal)
        {
            ...
            var
                myInt: Integer;
            begin
                IF "Line Budget Cost" < ("Amount(1st Quarter)" + "Amount(2nd Quarter)" + "Amount(3rd Quarter)" + "Amount(4th Quarter)") THEN BEGIN
        ...
        field(47; "Qty(2nd Quarter)"; Integer)
        {
            ...
            begin
                IF Quantity < ("Qty(1st Quater)" + "Qty(2nd Quarter)" + "Qty(3rd Quarter)" + "Qty(4th Quarter)") THEN BEGIN
                    ERROR('Error!, Kindly Align the Planning Quantities Correctly');
                END;
                "Amount(2nd Quarter)":="Qty(2nd Quarter)"*"Unit Cost";
                Validate("Amount(2nd Quarter)");
            end;
        }
        ...
        field(49; "Qty(3rd Quarter)"; Integer)
        {
            ...
            begin
                IF Quantity < ("Qty(1st Quater)" + "Qty(2nd Quarter)" + "Qty(3rd Quarter)" + "Qty(4th Quarter)") THEN BEGIN
                    ERROR('Error!, Kindly Align the Planning Quantities Correctly');
                END;
                 "Amount(3rd Quarter)":="Qty(3rd Quarter)"*"Unit Cost";
                Validate("Amount(3rd Quarter)");
            end;
        }
        ...
        field(51; "Qty(4th Quarter)"; Integer)
        {
            ...
            begin
                IF Quantity < ("Qty(1st Quater)" + "Qty(2nd Quarter)" + "Qty(3rd Quarter)" + "Qty(4th Quarter)") THEN BEGIN
                    ERROR('Error!, Kindly Align the Planning Quantities Correctly');
                END;
                "Amount(4th Quarter)":="Qty(4th Quarter)"*"Unit Cost";
                Validate("Amount(4th Quarter)");
            end;
        }
        ...
        field(50028; "Plan Item Type"; Option)
        {
        ...
        field(50029; "Plan Item No"; Code[50])
        {
            DataClassification = ToBeClassified;
            TableRelation = IF ("Plan Item Type" = CONST(Item)) Item."No." WHERE("Item Category Code" = FIELD("Planning Category")) ELSE
    ...
    keys
    {
        key(Key1; "Procurement Plan ID", "Entry No.", "Planning Category")
        {
            Clustered = true;
        }
    }
