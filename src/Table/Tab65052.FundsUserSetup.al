...
Table 65052 "Funds User Setup"
{
    ...
    fields
    {
        ...
        field(82; "Interfund Journal Template"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Gen. Journal Template".Name where(Type = const(Jobs));
        }
        field(83; "Interfund Journal Batch"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Gen. Journal Batch".Name where("Journal Template Name" = field("Interfund Journal Template"));
