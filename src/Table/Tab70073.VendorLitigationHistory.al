...
Table 70073 "Vendor Litigation History"
{
    Caption = 'Contact';
    ...
    fields
    {
        ...
        field(7;"3rd Party Entity";Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(8;"Dispute Amount LCY";Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(9;"Award Type";Option)
        {
            DataClassification = ToBeClassified;
    ...
    fieldgroups
    {
        fieldgroup(DropDown;"Entry No.","Vendor No.","3rd Party Entity","Award Type")
        {
        }
        fieldgroup(Brick;"Entry No.","Vendor No.","3rd Party Entity","Award Type")
        {
        }
    }
