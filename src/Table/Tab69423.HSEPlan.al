    ...
    fields
    {
        ...
        field(4;"Risk Management Plan ID";Code[20])
        {
            ...
            TableRelation = if ("Plan Type"=const(Corporate)) "Risk Management Plan"."Document No" where ("Document Type"=const(Corporate))
                            else if ("Plan Type"=const("Functional (Directorate)")) "Risk Management Plan"."Document No" where ("Document Type"=const("Functional (Directorate)"))
                            else if ("Plan Type"=const("Functional (Department)")) "Risk Management Plan"."Document No" where ("Document Type"=const("Functional (Department)"))
                            else if ("Plan Type"=const("Functional (Region)")) "Risk Management Plan"."Document No" where ("Document Type"=const("Functional (Region)"));
        }
