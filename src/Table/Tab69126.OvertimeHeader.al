                            ...
                            if Employee.Get("EMp No.") then begin
                               ...
                               //     SenderName := SMTPSetup."Email Sender Name";
                                ...
                                //    SMTPMail.Create(SenderName, SenderEmail, Employee."E-Mail", Header, '', true);
                                    ...
                                    // SMTPMail.AppendToBody('<br><br>');
                                    // SMTPMail.AppendToBody('This is to inform you that your overtime application ' + "Application Code" + ' has been processed');// for the month of January 2014');
                                    // SMTPMail.AppendToBody('<br><br>');
                                    // SMTPMail.AppendToBody('An allowance of KES ' + Format("Overtime Amount") + ' has been added to payroll for the month of ' + Format(Month));
                                    // SMTPMail.AppendToBody('<br><br>');
                        ...
                        if LeaveGjline.Insert(true) then begin
                         ...
                         //           SenderName := SMTPSetup."Email Sender Name";
                             ...
                             //       SMTPMail.Create(SenderName, SenderEmail, Employee."E-Mail", Header, '', true);
                                    ...
                                    // SMTPMail.AppendToBody('This is to inform you that your overtime application ' + "Application Code" + ' has been processed');// for the month of January 2014');
                                    // SMTPMail.AppendToBody('<br><br>');
                                    // SMTPMail.AppendToBody('A total of  ' + Format(ROUND(("Total Hours" / 8), 0.1, '>')) + 'days has been added to your leave balance ');
                                    // SMTPMail.AppendToBody('<br><br>');
                                    // SMTPMail.AppendToBody('Thanks & Regards');
                                    // SMTPMail.AppendToBody('<br><br>');
                                    // SMTPMail.AppendToBody(SenderName);
