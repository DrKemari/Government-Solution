...
Table 85107 "Scripts Dispatch Lines"
{
    ...
    fields
    {
        ...
        field(11; "Center Code"; Code[30])
        {
            ...
            begin
                ...
                ExamScriptsEntries.SetRange("Examination Sitting", "Examination Sitting");
        ...
        field(17; "No. of Envelope Scripts"; Integer)
        {
            ...
            trigger OnValidate()
            begin
                Variance := "No. of Envelope Scripts" - "No. of Scripts Returned";
            end;
        }
        ...
        field(19; "Marksheet Issued"; Boolean)
        {
            ...
            begin
                ...
                // IF ScriptsDispatchLines.FINDFIRST THEN
                //  ERROR(TXT001);
                TestField("Script Returned", true);
                "Issued By" := UserId;
        ...
        field(32; "Script Returned On"; DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(33; "Script Returned BY"; Code[50])
        {
            DataClassification = ToBeClassified;
        }
        field(34; Allocated; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(35; "Allocated On"; DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(36; "Allocated BY"; Code[50])
        {
            DataClassification = ToBeClassified;
        }
    ...
    keys
    {
        key(Key1; "Document No.", Examination, "Examination Sitting", "Paper Code", "Center Code", "Entry No")
        {
            Clustered = true;
        }
    }
