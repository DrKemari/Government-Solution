...
Table 69616 "Recruitment Planning Line"
{
    ...
    fields
    {
        ...
        field(2; "Position ID"; Code[30])
        {
            ...
            TableRelation = if ("Position Category" = const(Employee)) "Establishment Planning Line"."Position ID" where("Duty Station ID" = field(Department),
                                                                                                                         Blcoked = const(false))
            else
                ...
                if RecruitmentPlan.FindSet then begin
                    ...
                    if RecruitmentPlan."Recruitment Plan Type" = RecruitmentPlan."recruitment plan type"::"Functional Plan"
                       then begin
                        ...
                        PlanningLine.SetRange("Duty Station ID", Department);
