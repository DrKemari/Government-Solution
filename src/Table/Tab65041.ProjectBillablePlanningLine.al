...
Table 65041 "Project Billable Planning Line"
{
    ...
    fields
    {
        ...
        field(1000;"Job Task No.";Code[20])
        {
            ...
            begin
                   ...
                   if JobLedgerEntry.Find('-') then begin
                      "Unit Price":= JobLedgerEntry."Unit Cost";
                      "Unit Price (LCY)":=JobLedgerEntry."Unit Cost (LCY)";
                       Type:=JobLedgerEntry.Type;
        ...
        field(65003;"Project Billable ID";Code[50])
        {
            DataClassification = ToBeClassified;
            Description = 'Added for Project Procurement Plan';
        }
    ...
    keys
    {
        key(Key1;"Job No.","Line No.","Project Billable ID","Job Task No.")
        {
            Clustered = true;
        }
    }
