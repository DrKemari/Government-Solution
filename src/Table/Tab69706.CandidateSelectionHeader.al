    ...
    fields
    {
        ...
        field(4;"Source Document No.";Code[30])
        {
            ...
            TableRelation = if ("Source Type"=filter("Final Shortlisting")) "Candidate Selection Header"."Document No." where ("Document Type"=filter("Candidate Shortlisting"),
                                                                                                                               ...
                                                                                                                               else if ("Source Type"=filter("Previous Interview")) "Candidate Selection Header"."Document No." where ("Document Type"=filter("Interview Invitation"),
                                                                                                                                                                                                                                       "Vacancy ID"=field("Vacancy ID"),
                                                                                                                                                                                                                                       Posted=filter(true));
        }
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = "Candidate Selection Committee"."Member No." where (Role=filter(Chairperson),
