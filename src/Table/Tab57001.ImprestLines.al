            ...
            begin
             repeat
               if not ProjectMembers."Project Lead" then//Check whether Project lead or not
                begin
                 if (ProjectMembers."Work Type"=ImpLines."Work Type") and (ProjectMembers."No."=ImpLines."Resource No.") then
                   begin
                ...
                begin
                  ...
                  ProjectMembers2.SetRange(Linked,true);
                   if ProjectMembers2.Find('-') then
                     repeat
                      if (ProjectMembers."Work Type"=ImpLines."Work Type") and (ProjectMembers2."No."=ImpLines."Resource No.")then
                        begin
                  ...
                  Casuals.SetRange(Linked,true);
                   if Casuals.Find('-') then
                      repeat
                        if (Casuals."Work Type"=ImpLines."Work Type") and (Casuals."Resource No."=ImpLines."Resource No.") then
                          begin
                  ...
                  OtherCosts.SetRange(Linked,true);
                   if OtherCosts.Find('-') then
                      repeat
                        if OtherCosts."No."=ImpLines."Account No." then
                          begin
