...
Table 65034 "GFA Opportunity"
{
    ...
    fields
    {
        ...
        field(10; Status; Option)
        {
            Caption = 'Status';
            Editable = false;
            OptionCaption = 'Not Started,In Progress,Successful,Not Successful';
    ...
    local procedure InsertOpportunity(var Opp2: Record "Grant Funding Application"; OppEntry2: Record "GFA Opportunity Entry"; var RMCommentLineTmp: Record "Rlshp. Mgt. Comment Line"; ActivateFirstStage: Boolean)
    var
        SegHeader: Record "Segment Header";
        SegLine: Record "Segment Line";
    ...
    begin
        ...
        if CustTemplateCode <> '' then
            SalesHeader.Validate(SalesHeader."Sell-to Customer Templ. Code", CustTemplateCode);
        SalesHeader.Modify;
