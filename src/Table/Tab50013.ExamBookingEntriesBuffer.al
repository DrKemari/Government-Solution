...
Table 50013 "Exam Booking Entries-Buffer"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = 'Open,Ongoing,Withdrawn,Defered,Closed,Failed,Cancelled,Passed';
            OptionMembers = Open,Ongoing,Withdrawn,Defered,Closed,Failed,Cancelled,Passed;
        }
