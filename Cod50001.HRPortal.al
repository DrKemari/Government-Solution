...
#pragma warning disable AA0005, AA0008, AA0018, AA0021, AA0072, AA0137, AA0201, AA0206, AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
    ...
    procedure FnCreateLeaveApplication(leaveNo: Code[20]; employeeNo: Code[20]; leaveType: Code[20]; annualLeaveType: Integer; days: Integer; startDate: Date; reliever: Code[20]; phone: Text; email: Text; examDetails: Text; examDate: Date) status: Text
    var
    ...
    procedure CreateLeaveApplication(employeeNo: Code[20]; leaveType: Code[20]; annualLeaveType: Integer; days: Integer; startDate: Date; reliever: Code[20]; phone: Text; email: Text; examDetails: Text; examDate: Date) leaveNo: Text
    var
        tbl_leaveApplications: Record "HR Leave Application";
    begin
        if HrSetup.Get() then
        ...
        if leaveNo = '' then begin
            ...
            tbl_leaveApplications."Date of Exam" := examDate;
            tbl_leaveApplications."Details of Examination" := examDetails;
            tbl_leaveApplications.INSERT(TRUE);
        ...
        IF tbl_employee.FindSet() THEN BEGIN
            ...
            IF PurchaseHeader.FindSet() THEN BEGIN
                ...
                IF tbl_userSetup.FindSet() THEN BEGIN
                    ...
                    PurchaseHeader."Shortcut Dimension 1 Code" := txtdirectorate;
    ...
    procedure addPettyCashRequisitionLines(docNo: Text; expenditure: Text; amount: Decimal) status: Text
    begin
        PVLines.INIT;
        PVLines.No := docNo;
    ...
    begin
        if HREmp.Get(StaffNoFilter) then begin
            ...
            HREmp.CalcFields("Annual Leave Account");
            ...
            DaysCalculated[1] := HREmp."Annual Leave Account"; //AllocatedDays + HREmp."Reimbursed Leave Days";
    ...
    procedure HRTimeOffLieu(EmployeeNo: Code[20]; AppliedDays: Decimal; SenderComments: Text; ResponsibilityCenter: Code[20]; UserID: Text; StartTime: Time; EndTime: Time) DocNo: Code[20]
    var
        GenLedgerSetup: Record "General Ledger Setup";
        TheTable: Record "HR Leave Allocation Request";
    begin
        ...
        LeaveReq."Application Type" := LeaveReq."Application Type"::"Time Off Lie";
        LeaveReq."Adjustment Type" := LeaveReq."Adjustment Type"::"Positive Adjustment";
        if HREmp.Get(EmployeeNo) then begin
            HREmp.TestField(Gender);
            HREmp.TestField("Global Dimension 2 Code");
